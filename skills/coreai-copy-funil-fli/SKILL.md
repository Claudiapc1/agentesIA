---
name: copy-funil-fli
description: "Constrói o Funil de Lucro Imediato (FLI): oferta direta com upsell para caixa rápido."
when-to-use: >
  Quando o usuário quiser FLI, funil de lucro imediato, funil de caixa rápido, tripwire, ou disser "FLI", "funil de lucro imediato", "lucro imediato", ou /copy:funil-fli.
argument-hint: "[produto / oferta / contexto]"
allowed-tools: "Read, Write, Bash, Glob, Grep, Agent"
user-invocable: true
---

# Copy: Funil de Lucro Imediato (FLI)

Atalho de Funil de Lucro Imediato (FLI). Despacha o especialista certo e segue o workflow de referência.
