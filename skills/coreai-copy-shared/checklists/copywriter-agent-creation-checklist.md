...
> **Integration:** This checklist validates agents created via `tasks/dna-cloning/create-copywriter-agent.md`
...
Agent File: squads/copywriter-os/[DEPENDÊNCIA NÃO EMPACOTADA: ___________]
...
- **Phase 9** of `tasks/dna-cloning/create-copywriter-agent.md`
- Final validation before deployment
- Quality gate for all copywriter agents in CopywriterOS

### Related Files

- Master Task: `tasks/dna-cloning/create-copywriter-agent.md`
...
- Reference Agents: `agents/tier-2-executores/david-ogilvy.md`, `agents/tier-1-estrategistas/alex-hormozi.md`
