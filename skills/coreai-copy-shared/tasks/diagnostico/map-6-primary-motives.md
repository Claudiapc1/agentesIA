...
executor:
  ...
  rationale: "Evaldo Albuquerque domina a analise de motivos primarios e desejos ocultos, aplicando profundidade psicologica ao framework de Collier"
```
...
```yaml
pre_conditions:
  - Analise de conversa mental concluida (analyze-mental-conversation.md)
  - Publico-alvo definido com clareza
  - Produto/servico identificado
  - Pesquisa de cliente disponivel (entrevistas, reviews, dados de compra — recomendado)
```
...
```yaml
motive_mapping:
  audience: "Donos de agencia digital, 30-80k/mes"
  ...
  motives_ranked:
    1_dominant:
      motive: GAIN
      score: 9/10
      evidence: "Querem faturar 100k+/mes e construir patrimonio"
      copy_angle: "O caminho mais rapido para sua agencia faturar 6 digitos por mes"

    2_secondary:
      motive: SELF-PRESERVATION
      score: 8/10
      evidence: "Medo de burnout, de perder saude e familia"
      copy_angle: "Antes que o burnout destrua o que voce construiu"

    3_tertiary:
      motive: PRIDE
      score: 7/10
      evidence: "Querem ser vistos como empresarios, nao freelancers"
      copy_angle: "Pare de ser o funcionario mais caro da sua propria empresa"

    4_support:
      motive: SELF-INDULGENCE
      score: 5/10
      evidence: "Desejam liberdade de horario e viagens"

    5_minor:
      motive: DUTY
      score: 4/10
      evidence: "Responsabilidade com equipe e familia"

    6_minimal:
      motive: LOVE
      score: 3/10
      evidence: "Querem estar presente para filhos"

  copy_recommendation: |
    Liderar com GAIN (resultado financeiro concreto) e reforcar com
    SELF-PRESERVATION (urgencia de mudar antes do burnout).
    PRIDE como terceiro layer nos depoimentos.
```

## Veto Conditions
- Mapeamento sem os 6 motivos completos de Collier
- Motivos genericos sem conexao com o produto/oferta
- Ignorar motivos negativos (medo, dever) focando so em positivos
