...
dependencies:
  ...
  reference:
    - agents/tier-1-estrategistas/dan-kennedy.md  # authority_proof_arsenal section
    - agents/tier-2-executores/david-ogilvy.md # authority_proof_arsenal section
  research:
...
See `agents/tier-1-estrategistas/dan-kennedy.md` for reference implementation:
...
See `agents/tier-2-executores/david-ogilvy.md` for reference implementation:
...
## Pre-Conditions
- Informacoes sobre o expert/autor (background, credenciais, resultados)
- Historia de origem e "Crucible Story" disponivel ou extraivel
- Produtos/clientes notaveis documentados
- Provas sociais e dados de autoridade acessiveis
- Template authority-arsenal-tmpl.yaml carregado

## Veto Conditions
- Arsenal sem elementos verificaveis de autoridade
- Claims de autoridade nao substanciados
- Ignorar framework de 6 tipos de autoridade
...
```yaml
# Authority Arsenal — Juliano Torriani

expert:
  name: "Juliano Torriani"
  slug: "juliano-torriani"

authority_elements:
  credentials:
    - type: "resultado_proprio"
      claim: "R$2.3M faturados com mentorias digitais em 24 meses"
      evidence: "Screenshots de plataforma + extrato Hotmart"
      strength: 9/10

    - type: "resultado_alunos"
      claim: "437 alunos formados, 67% com faturamento acima de R$5k/mês"
      evidence: "Dashboard de acompanhamento + depoimentos verificados"
      strength: 8/10

    - type: "midia"
      claim: "Participação no podcast Mentor Digital (ep. 147, 340k views)"
      evidence: "Link do episódio + print de views"
      strength: 6/10

  crucible_story:
    before: "Analista CLT ganhando R$3.200/mês, demitido em 2019"
    turning_point: "Primeiro lançamento semente com R$800 de faturamento"
    after: "Negócio de R$47k/mês com 3 produtos e equipe de 4 pessoas"
    emotional_hook: "O dia que minha esposa perguntou se a gente ia perder a casa"

  social_proof_stack:
    - "437 alunos formados"
    - "4.8/5 média de avaliação (NPS 72)"
    - "R$2.3M em resultados dos mentorados"

arsenal_score: 7.8/10
gaps: ["Falta certificação reconhecida", "Sem livro publicado ainda"]
```
