...
dependencies:
  tasks:
    - tasks/dna-cloning/extract-frameworks.md
    - tasks/dna-cloning/extract-communication-dna.md
    - tasks/dna-cloning/extract-signature-phrases.md
    - tasks/brunson/build-authority-arsenal.md
    - tasks/estrategia/create-objection-algorithms.md
  templates:
  ...
  reference:
    - agents/tier-1-estrategistas/dan-kennedy.md
    - agents/tier-2-executores/david-ogilvy.md

outputs:
  primary: "agents/{slug}.md"
  analysis_files:
...
**Primary Reference:** `agents/tier-1-estrategistas/dan-kennedy.md`
**Secondary Reference:** `agents/tier-2-executores/david-ogilvy.md`
...
**Execute Sub-Task:** `tasks/dna-cloning/extract-frameworks.md`
...
**Execute Sub-Task:** `tasks/dna-cloning/extract-communication-dna.md`
...
**Execute Sub-Task:** `tasks/dna-cloning/extract-signature-phrases.md`
...
**Execute Sub-Task:** `tasks/brunson/build-authority-arsenal.md`
...
**Execute Sub-Task:** `tasks/estrategia/create-objection-algorithms.md`
...
```yaml
pre_conditions:
  - Minimo 20 arquivos-fonte do copywriter (livros, cartas, ads, transcricoes)
  - Nome completo e slug do copywriter definidos
  - Templates de agente disponiveis (copywriter-agent-tmpl.yaml)
  - Sub-tasks de extracao prontas (extract-frameworks, extract-communication-dna, extract-signature-phrases)
  - Agentes de referencia existentes para baseline (ex: dan-kennedy.md, david-ogilvy.md)
```

## Output Example

```yaml
# Trecho do agente gerado (copywriter-agent.yaml)
agent:
  name: "Ricardo Mendes Clone"
  slug: "ricardo-mendes"
  version: "1.0"

  identity:
    role: "Especialista em escala de agencias digitais"
    philosophy: "Processo antes de pessoas. Sistema antes de talento."
    tone: ["Direto", "Provocador", "Pratico"]

  thinking_patterns:
    primary: "Sempre comeca pelo gargalo operacional antes de falar de receita"
    objection_style: "Confronta com dados — 'Me mostra os numeros do seu delivery'"
    persuasion_model: "Dor operacional → Metodo → Caso real → Oferta"

  voice_dna:
    vocabulary_tier_1: ["escala", "operacional", "processo", "gargalo", "delivery"]
    signature_phrases:
      - "Voce nao tem um problema de vendas. Tem um problema de entrega."
      - "Contratar mais gente sem processo e pagar mais pra errar mais rapido."
    forbidden_words: ["facil", "rapido", "sem esforco", "magico"]

  frameworks:
    - name: "Metodo Triangulo"
      steps: ["Processo", "Pessoas", "Performance"]
    - name: "Sprint de Delegacao"
      steps: ["Mapear", "Documentar", "Treinar", "Soltar", "Auditar"]
```

## Veto Conditions
- Agente sem fontes primarias verificaveis do copywriter
- Persona generica sem voice DNA e thinking patterns
- Agente que nao reproduz estilo verificavel do original
