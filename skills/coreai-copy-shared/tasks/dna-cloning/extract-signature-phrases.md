...
Study the signature_phrases section in `agents/tier-1-estrategistas/dan-kennedy.md`:
...
executor:
  primary: copy-chief
  secondary: null
  rationale: "Copy Chief executa extracao de frases-assinatura como Phase 4 do pipeline de criacao de agente copywriter"
```
...
```yaml
pre_conditions:
  - Diretorio de materiais-fonte com minimo 20 arquivos processados
  - Template signature-phrases-tmpl.yaml disponivel
  - Agente de referencia para formato (dan-kennedy.md)
  - Minimo 42 frases candidatas identificadas no material
```
...
signature_phrases:
  ...
  tier_1_iconic: # Frases que definem o copywriter
    - phrase: "A starving crowd beats any other advantage"
      context: "Usado para ensinar que o mercado importa mais que a copy"
      frequency: "42 ocorrencias"
      usage: "Abertura de palestras, capitulos sobre mercado"

    - phrase: "Motion beats meditation"
      context: "Principio sobre agir antes de planejar"
      frequency: "28 ocorrencias"
      usage: "Motivacional, fechamento de cartas"

  tier_2_frequent:
    - phrase: "The most important thing in copy is the list"
      context: "Priorizacao de lista/audiencia sobre criatividade"
      frequency: "19 ocorrencias"

    - phrase: "Clarity above all else"
      context: "Principio de edicao — se nao esta claro, reescreva"
      frequency: "15 ocorrencias"

  tier_3_contextual:
    - phrase: "Write like you talk after three beers"
      context: "Tom conversacional, sem formalidade"
      frequency: "8 ocorrencias"
```

## Veto Conditions
- Frases genericas nao exclusivas do copywriter
- Extracao sem contexto de uso original
- Atribuir frases de outros autores
