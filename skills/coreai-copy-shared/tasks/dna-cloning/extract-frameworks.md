...
difficulty: advanced
elicit: true
parent_task: tasks/dna-cloning/create-copywriter-agent.md
phase: 2
...
dependencies:
  ...
  reference:
    - agents/tier-2-executores/david-ogilvy.md (structure reference)
    - agents/tier-1-estrategistas/dan-kennedy.md (structure reference)
    - agents/tier-1-estrategistas/alex-hormozi.md (structure reference)
  research:
...
- `agents/tier-1-estrategistas/alex-hormozi.md`
...
executor:
  primary: copy-chief
  secondary: null
  rationale: "Copy Chief executa extracao de frameworks como Phase 2 do pipeline de criacao de agente copywriter"
```
...
```yaml
pre_conditions:
  - Diretorio de materiais-fonte com minimo 20 arquivos do copywriter
  - Nome completo, slug e identificador do copywriter definidos
  - Template frameworks-extraction-tmpl.yaml disponivel
  - Agentes de referencia para estrutura (david-ogilvy.md, dan-kennedy.md, alex-hormozi.md)
```
...
frameworks_extracted:
  ...
  frameworks:
    - name: "Value Equation"
      category: "pricing"
      formula: "Value = (Dream Outcome x Likelihood) / (Time Delay x Effort)"
      application: "Justificar preco premium mostrando valor percebido"
      source: "$100M Offers, Cap. 7"

    - name: "Grand Slam Offer"
      category: "offer_creation"
      steps:
        - "Identificar Dream Outcome"
        - "Listar todos os problemas/obstaculos"
        - "Criar solucoes para cada problema"
        - "Dar nome e valor a cada solucao"
        - "Empacotar como oferta irrecusavel"
      source: "$100M Offers, Cap. 11-14"

    - name: "Lead Magnet Value Ladder"
      category: "lead_generation"
      principle: "Dar tanto valor gratis que pagar parece obrigacao"
      levels: ["Free content", "Lead magnet", "Low-ticket", "Core offer", "Premium"]
      source: "$100M Leads, Cap. 5"

  cross_references:
    - "Value Equation alimenta Grand Slam Offer"
    - "Lead Magnet inicia o funil que culmina na Grand Slam Offer"
```

## Veto Conditions
- Frameworks inventados nao atribuiveis ao copywriter
- Extracao sem exemplos concretos de aplicacao
- Frameworks genericos sem diferenciacao do autor
