...
## Pre Conditions
- Sequencia completa de PLCs entregue a audiencia
- Launch stack finalizado com bonus, precos e garantia definidos
- Testimonials e provas sociais coletados durante o prelaunch
- Checkout integrado e testado com transacao real
- Template de sales page PLF disponivel (templates/plf/sales-page-blueprint-tmpl.md)
- Datas de cart open/close confirmadas para elementos de urgencia

## Veto Conditions
- Nao criar sales page PLF sem sequencia de PLCs entregue a audiencia
- Nao executar sem launch stack e bonus finalizados
- Nao produzir sem testimonials e provas sociais coletados durante o prelaunch
...
```markdown
# Sales Page PLF — Programa Acelerador Digital (Headline + Abertura)

## Headline
De Mentor Invisível a R$30k/Mês: O Sistema de 5 Passos
Que 437 Profissionais Já Usaram Para Transformar Conhecimento
em Renda Previsível
...
## Abertura (pós-PLC)
Você assistiu os 3 vídeos.

Viu como a Fernanda saiu de ZERO para R$18k/mês em 60 dias.
Viu como o Ricardo fez seu primeiro R$12k com uma lista de 340 pessoas.
Viu o sistema completo funcionando na prática.

Agora é hora de decidir:

Você vai continuar tentando sozinho — postando sem estratégia,
criando produto sem validar, queimando meses —

Ou vai usar o mesmo sistema que já gerou R$2.3M em resultados
para nossos mentorados?

Se você quer o caminho rápido, continue lendo.

[CTA: QUERO ENTRAR NO ACELERADOR →]
```
