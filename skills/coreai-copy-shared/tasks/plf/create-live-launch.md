...
## Pre Conditions
- Formato do evento ao vivo definido (webinar, workshop, challenge)
- Plataforma de streaming/webinar selecionada e testada
- Conexao de internet confiavel (10+ Mbps upload)
- Produto/oferta finalizado com preco e bonus
- Conteudo dos PLCs alinhado com roteiro do evento ao vivo
- Equipe de suporte disponivel (moderacao de chat, tech support)
- Estrategia de replay definida (sem replay, limitado, completo)

## Veto Conditions
- Nao criar live launch sem formato definido (webinar, workshop, challenge)
- Nao executar sem infraestrutura tecnica confirmada (plataforma, streaming, checkout)
- Nao produzir sem conteudo dos PLCs alinhado com o evento ao vivo
...
```markdown
# Live Launch Plan — Mentoria Elite (Workshop 3 Dias)

## Formato: Workshop ao Vivo (3 sessões)
| Dia | Tema | Duração | Horário |
|-----|------|---------|---------|
| Dia 1 (Seg) | A Oportunidade: Por que mentores digitais faturam pouco | 90 min | 20h BRT |
| Dia 2 (Qua) | O Sistema: Método 3R na prática (cases ao vivo) | 90 min | 20h BRT |
| Dia 3 (Sex) | Seu Plano: Implementação + Oferta | 120 min | 20h BRT |

## Estrutura do Dia 3 (Pitch)
- 00-05min: Boas-vindas + Poll "O que mais impactou você?"
- 05-60min: Conteúdo — Montando seu plano de 90 dias
- 60-65min: Transição — "Agora, pra quem quer ir mais rápido..."
- 65-100min: Stack + Preço + Bônus + Garantia
- 100-120min: Q&A ao vivo + celebração dos primeiros compradores

## Show-Up Strategy
- Bônus exclusivo para quem assistir AO VIVO (checklist PDF)
- 4 emails de lembrete (confirmação, véspera, manhã, 1h antes)
- Replay limitado: 48h após cada sessão
```
