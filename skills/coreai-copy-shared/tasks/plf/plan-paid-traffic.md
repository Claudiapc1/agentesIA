...
## Pre Conditions
- Pelo menos um lancamento organico bem-sucedido concluido com dados de conversao
- Taxas de conversao de opt-in e venda comprovadas (para calcular economics)
- Orcamento de ads alocado e aprovado
- Pixels de rastreamento instalados e verificados (Facebook, Google, etc.)
- Landing pages prontas e testadas para receber trafego
- Publicos custom e lookalike criados (ou dados para criar)

## Veto Conditions
- Nao planejar trafego pago sem pelo menos um lancamento organico bem-sucedido
- Nao executar sem taxas de conversao de opt-in e venda comprovadas
- Nao investir sem tracking e atribuicao configurados corretamente
...
```markdown
# Plano de Tráfego Pago — Lançamento Acelerador Digital (Maio/2026)

## Budget Total: R$15.000
| Fase | Budget | Objetivo | Métrica-Alvo |
|------|--------|----------|--------------|
| List Building (D-30 a D-14) | R$8.000 | 2.000 leads | CPL < R$4,00 |
| Retargeting PLCs (D-1 a D-10) | R$4.000 | Engajamento | CPC < R$0,80 |
| Cart (D-11 a D-15) | R$3.000 | Conversão | ROAS > 3x |

## Públicos
- **Cold:** Lookalike 1% de compradores anteriores (Facebook/Instagram)
- **Warm:** Visitantes sales page + assistiram 50%+ dos PLCs
- **Hot:** Abandonaram checkout + abriram email de cart

## Anúncio de Captação — Amostra
"87% dos mentores digitais nunca passam de R$5k/mês.
Os outros 13% usam um SISTEMA.
Assista a masterclass gratuita e descubra qual é.
→ [CTA: Quero assistir grátis]"

## Economics Projetado
2.000 leads × 50% engajados × 3% conversão × R$997 = R$29.910
ROAS projetado: 2.0x (conservador)
```
