...
## Pre Conditions
- Acesso a clientes/alunos com resultados reais documentados
- Permissao explicita do cliente para usar nome, foto e historia
- Formato de uso definido (PLC2, sales page, email, ads)
- Avatar do lancamento claramente definido para selecionar cases representativos
- Objecoes principais do publico mapeadas para orientar selecao de cases

## Veto Conditions
- Nao criar case study sem acesso a resultados reais e verificaveis do cliente
- Nao executar sem permissao explicita para compartilhar a historia
- Nao produzir sem definir onde o case study sera usado (PLC2, sales page, email)
...
### Checklists
- `checklists/plf/cpl1-opportunity-checklist.md (e cpl2/cpl3/cpl4 conforme o CPL)` (case study section)
...
```markdown
### Marina Silva — De R$2.800/mês CLT para R$47.000/mês como Mentora

**A Situação:**
Marina era analista de RH há 12 anos. Ganhava R$2.800 e sentia que desperdiçava
seu conhecimento em processos burocráticos. Já tinha tentado dois cursos online
que nunca saíram do papel.

**O Ponto de Virada:**
"Vi a aula do Programa Acelerador Digital e pensei: 'Isso é diferente.
Não é teoria — é um sistema.' Me inscrevi no último dia, com medo."

**Os Resultados:**
- Primeiro lançamento: R$12.400 em 7 dias (lista de 340 pessoas)
- Terceiro lançamento: R$47.000 (lista de 1.200 pessoas)
- Saiu do CLT em 5 meses

> "Se eu tivesse esperado mais um mês pra decidir, estaria até hoje
> no escritório reclamando da vida. Meu único arrependimento é não
> ter começado antes."

**Objeção que endereça:** "Não tenho audiência grande o suficiente"
```
