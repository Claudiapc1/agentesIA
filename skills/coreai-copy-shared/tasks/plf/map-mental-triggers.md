...
## Pre Conditions
- Sequencia de lancamento planejada (PLCs + emails pelo menos delineados)
- Avatar com psicologia mapeada (medos, desejos, motivacoes emocionais)
- Credenciais e provas de autoridade inventariadas
- Social proof disponivel (testimonials, case studies, numeros)
- Tipo de escassez definido (tempo, quantidade, preco)
- Referencia ao mental-triggers-kb.yaml carregada

## Veto Conditions
- Nao mapear triggers sem sequencia de lancamento (PLCs + emails) definida
- Nao executar sem avatar e suas motivacoes emocionais mapeadas
- Nao produzir sem garantir que todos os 9 triggers de Walker estejam cobertos
...
```markdown
# Mapa de Mental Triggers — Programa Acelerador Digital

## Distribuição por Fase
| Trigger | Pre-Pre | PLC1 | PLC2 | PLC3 | Cart | Score |
|---------|---------|------|------|------|------|-------|
| Authority | ● | ●● | ● | | ● | 5/5 |
| Reciprocity | | ●● | ●● | ● | | 5/5 |
| Trust | ● | ● | ●● | ● | ● | 6/5 |
...
## Gaps Identificados
- Authority AUSENTE no cart — adicionar "credenciais" na sales page
- Events FRACO no PLC2 — transformar revelação do case em "momento"

## Trigger Mais Forte: Social Proof (PLC2 + Cart)
## Trigger Mais Fraco: Events — reforçar com countdown e livestream
```
