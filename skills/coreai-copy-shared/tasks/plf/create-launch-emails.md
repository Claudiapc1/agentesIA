...
## Pre Conditions
- Timeline completa do lancamento definida (datas de pre-prelaunch, PLCs, cart open/close)
- PLCs criados ou pelo menos delineados com temas e objetivos
- Launch stack finalizado com bonus e precos definidos
- Sales page criada ou em producao simultanea
- Avatar claramente definido com linguagem mapeada
- Case studies e testimonials prontos para integracao nos emails
- Plataforma de email configurada com segmentacao funcional

## Veto Conditions
- Nao criar emails de lancamento sem timeline completa das fases (pre-prelaunch, PLC, cart)
- Nao executar sem PLCs criados ou pelo menos delineados
- Nao produzir sem launch stack e sales page finalizados
...
```markdown
# Email de Lançamento — PLC1 Announcement

Assunto: O vídeo que pode mudar seu negócio (assista agora)

[NOME],

Nos últimos 3 meses eu trabalhei em algo que pode transformar
a forma como você atrai clientes.

Acabei de publicar o primeiro vídeo da série "Os 3 Pilares
do Mentor Digital" — e você pode assistir agora:

→ [LINK]

Nesse vídeo você vai descobrir:
• Por que 87% dos mentores nunca passam de R$5k/mês
• O pilar invisível que separa quem escala de quem estagna
• O erro #1 que eu cometi (e que me custou R$120k)

Esse não é um vídeo genérico. Eu mostro o sistema exato
que usei para ir de R$3k para R$47k/mês.

Assista aqui: [LINK]

Amanhã o vídeo 2 vai ao ar — e o que eu revelo lá
vai te surpreender.

Juliano

P.S. Mais de 200 pessoas já assistiram nas primeiras
2 horas. Assista antes que eu tire do ar: [LINK]
```
