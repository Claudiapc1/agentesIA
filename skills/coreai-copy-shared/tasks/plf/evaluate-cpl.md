...
## Pre Conditions
- Production Aid correspondente ao numero do CPL carregado COMPLETO
- Execution Checklist (cpl-evaluation-execution-checklist.md) carregado
- Arquivo de transcricao do CPL disponivel e acessivel
- Numero do CPL identificado (1, 2, 3 ou 4)
- Contexto do lancamento disponivel (produto, criador, avatar)
- Templates de output carregados (report, rubric, beat analysis)

## Veto Conditions
- Nao avaliar CPL sem carregar os production aids e execution checklist obrigatorios
- Nao executar sem o conteudo completo do PLC a ser avaliado
- Nao produzir score sem comparar contra rubric e beat analysis do framework
...
production_aids:
  1: "checklists/plf/plc1-complete-production-aid.md"  # ~590 lines
  2: "checklists/plf/plc2-complete-production-aid.md"  # ~827 lines
  3: "checklists/plf/plc3-complete-production-aid.md"  # ~943 lines
  4: "checklists/plf/sales-video-complete-production-aid.md"  # ~1126 lines

# 3. Templates for output
templates:
  report: "templates/plf/cpl-evaluation-report-tmpl.md"
  rubric: "templates/plf/rubric-scores-tmpl.yaml"
  beats: "templates/plf/beat-analysis-tmpl.yaml"

# 4. Workflow reference
workflow: "workflows/wf-evaluate-cpl.yaml"
```
...
```markdown
# Avaliação CPL2 — Programa Acelerador Digital

## Score Geral: 28/37 (76%) — APROVADO COM RESSALVAS

## Breakdown por Dimensão
| Dimensão | Score | Nota |
|----------|-------|------|
| Recap do PLC1 | 4/5 | Bom, conectou bem |
| Case Study Principal | 3/7 | FRACO: faltou números específicos |
| Cases Secundários | 5/7 | 2 cases bons, 1 genérico |
| Ensino Profundo | 6/7 | Excelente — framework aplicável |
| Objeções | 4/5 | Endereçou 2 de 3 objeções-chave |
| Teaser PLC3 | 4/4 | Forte antecipação criada |
| Triggers Ativados | 2/2 | Social Proof + Reciprocidade |

## Problemas Críticos
1. Case principal (Marina) diz "resultados incríveis" sem
   quantificar — precisa de números: R$, %, timeline
2. Objeção "não tenho tempo" não foi endereçada

## Recomendações
- Refazer case Marina com dados: "saiu de R$2.8k para R$47k em 5 meses"
- Adicionar mini-case de alguém que trabalha CLT e conseguiu resultados
```
