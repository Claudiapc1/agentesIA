...
## Pre Conditions
- Sequencia de PLCs finalizada e entregue a audiencia
- Sales page publicada e funcional com checkout testado
- Launch stack completo com bonus e precos definidos
- Datas exatas de abertura e fechamento do carrinho confirmadas
- Testimonials e social proof prontos para uso nos emails
- Fast action bonus definido com deadline especifica (se aplicavel)
- Plataforma de email com segmentacao por engajamento configurada

## Veto Conditions
- Nao criar open cart sem PLCs finalizados e entregues a audiencia
- Nao executar sem sales page e checkout testados e funcionando
- Nao produzir sem datas exatas de abertura e fechamento do carrinho
...
```markdown
# Open Cart Email — Dia 5 (Último Dia), Email 3: Final Call

Assunto: Fechando em 2 horas

[NOME],

Daqui a 2 horas o Programa Acelerador Digital fecha.

Não vou estender. Não vou reabrir semana que vem.
Quando o relógio zerar, acabou.

437 pessoas já entraram desde segunda-feira.
Cada uma delas decidiu que estava na hora de parar
de adiar e começar a construir algo real.

Se você está lendo isso, é porque uma parte sua
sabe que precisa disso.

Confie nessa parte.

→ Entrar agora (últimas 2 horas): [LINK]

Nos vemos do outro lado.

Juliano

P.S. "Eu quase não entrei. Quase deixei o medo ganhar.
Hoje faturo R$23k/mês. Obrigada por não ter desistido
de mim." — Carla, turma de Janeiro.
```
