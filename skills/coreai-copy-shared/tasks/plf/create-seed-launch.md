...
## Pre Conditions
- Expertise comprovada no topico para poder ensinar ao vivo
- Lista de email existente (minimo 100-500 pessoas)
- Disponibilidade de tempo para entregar o produto ao vivo durante semanas de criacao
- Conceito do produto definido (transformacao, formato, duracao)
- Preco beta definido (tipicamente 40-60% do preco futuro)
- Capacidade maxima de participantes definida

## Veto Conditions
- Nao criar seed launch sem expertise comprovada para ensinar o topico ao vivo
- Nao executar sem lista minima (100-500 pessoas) para validar demanda
- Nao produzir sem disponibilidade real para entregar o produto ao vivo durante criacao
...
```markdown
# Seed Launch Plan — Método 3R (Validação)

## Conceito
- Produto: Mentoria em grupo "Método 3R" (Reposicionar, Reter, Rentabilizar)
- Formato: 6 encontros ao vivo via Zoom (1x/semana, 90 min cada)
- Preço beta: R$497 (preço futuro estimado: R$997)
- Capacidade: 15 vagas máximas
- Lista atual: 320 pessoas (email)

## Email de Convite (Seed)
Assunto: Quero sua ajuda com algo (15 vagas)

[NOME], estou criando algo novo e preciso de um grupo
pequeno de pessoas pra testar comigo.

É uma mentoria ao vivo de 6 semanas sobre como transformar
sua expertise em um negócio digital de R$10k+/mês.

Vou entregar tudo AO VIVO — e você me dá feedback honesto.

O investimento é R$497 (menos da metade do que vai custar
quando eu lançar oficialmente).

São apenas 15 vagas. Quando preencher, fechou.

Quer participar? Responde esse email com "EU QUERO".

## Meta de Validação
- 15 vagas vendidas em 7 dias = produto validado
- NPS > 8 ao final = conteúdo validado
- 3+ testimonials coletados = pronto para Internal Launch
```
