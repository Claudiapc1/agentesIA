...
## Pre Conditions
- Pelo menos UM lancamento ao vivo concluido com dados de conversao reais
- PLCs gravados ou filmados e prontos para adaptacao evergreen
- Sales page com conversao comprovada (minimo 2% da lista engajada)
- Plataforma de automacao de email com suporte a sequencias baseadas em data
- Ferramenta de deadline real (Deadline Funnel ou similar) configurada
- Fonte de trafego consistente planejada para alimentar o funil

## Veto Conditions
- Nao criar evergreen sem ter pelo menos UM lancamento ao vivo bem-sucedido como base
- Nao executar sem dados de conversao do lancamento original (taxas, receita, objecoes)
- Nao produzir sem PLCs gravados e sales page com conversao comprovada
...
```markdown
# Evergreen Launch — Mentoria Elite (Resumo Executivo)

## Arquitetura do Funil
Opt-in (Masterclass Grátis) → PLC1 (Day 0) → PLC2 (Day 2) → PLC3 (Day 4)
→ Cart Open (Day 5) → Cart Close (Day 9) → Expired Page + Waitlist

## Modelo de Timeline: Comprimido (9 dias)
- PLCs: 5 dias (vídeos gravados, adaptados do lançamento ao vivo de Jan/2026)
- Cart Open: 4 dias com deadline individual via Deadline Funnel

## Email Evergreen — Amostra (Day 5: Cart Open)
Assunto: As portas acabaram de abrir pra você

[NOME], durante os últimos dias você viu como o Método 3R transforma
resultados de mentores que faturam abaixo de R$10k/mês.

Agora é sua vez.

A Mentoria Elite está aberta — mas apenas por 4 dias.
Seu acesso expira em: [DEADLINE_TIMER]

→ Garanta sua vaga: [LINK]

## Meta de Performance
- Opt-in rate: 32% | Conversão: 2.8% | Revenue/opt-in: R$28
```
