...
## Pre Conditions
- Oferta validada por pelo menos um lancamento interno bem-sucedido
- Dados de conversao e EPC do lancamento interno disponiveis
- Sistema de tracking de afiliados configurado e testado
- Estrutura de comissao definida (tipicamente 40-50%)
- Relacionamento existente com potenciais parceiros (pelo menos 5-10 contatos quentes)
- Swipe copy e materiais promocionais prontos para parceiros
- Minimo 60-90 dias antes da data do lancamento para recrutamento

## Veto Conditions
- Nao criar JV launch sem oferta validada por pelo menos um lancamento interno
- Nao executar sem estrutura de comissao e sistema de tracking de afiliados definidos
- Nao produzir sem swipe copy e materiais promocionais prontos para parceiros
...
```markdown
# JV Launch Strategy — Programa Acelerador Digital

## Estrutura de Comissão
- Comissão: 40% (R$398,80 por venda de R$997)
<!-- Dependência externa de contexto/identidade excluída: aplicar contrato CoreAI. -->
- Pagamento: até 30 dias após encerramento do carrinho

## Partner Tiers (Meta: 15 parceiros)
| Tier | Parceiros-Alvo | Lista Estimada |
|------|----------------|----------------|
| A-List (3) | @fulano, @ciclana, @beltrano | 50k+ cada |
| B-List (5) | Influencers do nicho | 10-50k cada |
| C-List (7) | Peers e micro-influencers | 1-10k cada |
| **Total** | **15 parceiros** | **~180k reach** |

## Email de Recrutamento — Amostra
Assunto: Parceria para lançamento em Maio?

Oi [NOME], acompanho seu trabalho com [TEMA] faz tempo.

Estou planejando o lançamento do Acelerador Digital em Maio
e acredito que sua audiência se beneficiaria muito.

Nosso último lançamento interno converteu 3.2% da lista
engajada, com EPC de R$4,70.

Posso te mandar os detalhes?

## Premiação
1º lugar: iPhone 16 Pro + acesso VIP vitalício
2º-5º: R$500 em créditos + menção no evento
```
