...
2. □ Use this in create-sales-page.md or create-vsl.md
...
- **Prerequisites**: diagnose-awareness.md, diagnose-sophistication.md
...
executor:
  ...
  rationale: "Todd Brown como criador do E5 Method e framework completo de Unique Mechanism (Problem + Solution Mechanism)"
```
...
```yaml
pre_conditions:
  - Diagnostico de awareness e sofisticacao concluidos
  - Mercado em Stage 3+ de sofisticacao (mecanismo e obrigatorio)
  - Produto/servico com diferencial real identificavel
  - Concorrentes e suas promessas/mecanismos mapeados
  - Avatar/ICP definido com dores, desejos e crencas claros
  - Big Idea definida ou sera criada junto (task integra Big Idea + Mechanism)
```
...
unique_mechanism:
  ...
  problem_mechanism:
    name: "O Ciclo do Dono-Gargalo"
    what_it_is: |
      Toda agencia que cresce sem processo cria um ciclo vicioso:
      mais clientes → mais trabalho do dono → menos qualidade →
      churn → precisa de mais clientes. O dono VIRA o gargalo.
    why_others_fail: |
      Concorrentes ensinam a "vender mais" ou "contratar gerente",
      mas nao resolvem o ciclo — so aceleram. Mais vendas sem processo
      = mais caos.

  solution_mechanism:
    name: "Sprint de Delegacao de 14 Dias"
    what_it_is: |
      Sistema de 5 etapas que extrai o dono de 80% das tarefas
      operacionais em 14 dias, usando documentacao just-in-time
      e treinamento por video de 5 minutos.
    steps: ["Mapear", "Documentar", "Treinar", "Soltar", "Auditar"]
    why_different: |
      Nao exige contratar gerente (R$ 8-15k/mes). Usa a equipe que
      ja existe com processos que qualquer estagiario segue.
    evidence: "47 agencias implementaram. Tempo medio de liberacao: 11 dias."

  big_idea: |
    "O problema da sua agencia nao e falta de clientes.
    E que VOCE e o produto — e produto nao escala."
```

## Veto Conditions
- Big idea/mecanismo generico sem diferenciacao real
- Mecanismo que nao pode ser substanciado com evidencias
- Copiar mecanismo de concorrente sem adaptacao original
