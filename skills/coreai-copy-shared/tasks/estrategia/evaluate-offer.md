...
- `diagnose-avatar.md` - Understanding customer desires
...
executor:
  ...
  rationale: "Alex Hormozi como criador da Value Equation e Grand Slam Offer criteria para auditoria sistematica de ofertas"
```
...
```yaml
pre_conditions:
  - Oferta existente documentada (produto, preco, bonus, garantia)
  - Dados de conversao disponiveis (ou sintomas de problema identificados)
  - Avatar/ICP definido com objecoes conhecidas
  - Concorrentes e suas ofertas mapeados para comparacao
  - Metricas basicas disponiveis (conversion rate, refund rate, ou feedback qualitativo)
```
...
```yaml
offer_evaluation:
  offer_name: "Mentoria Elite — Operacao Liberdade"
  price: "R$ 12.000"
  date: "2026-03-15"
  ...
  value_equation:
    dream_outcome: 9/10 # "Agencia rodando sem o dono" — muito desejavel
    perceived_likelihood: 7/10 # 47 cases, mas falta video-depoimento
    time_delay: 8/10 # 90 dias e rapido para a transformacao prometida
    effort_required: 7/10 # 2h/semana e bom, mas "sprint de 14 dias" soa intenso

  grand_slam_criteria:
    value_stack: "FORTE — ratio 2.7x, 4 bonus relevantes"
    scarcity: "REAL — 20 vagas por capacidade (nao artificial)"
    urgency: "MEDIA — 'proxima turma em 4 meses' poderia ser mais forte"
    guarantee: "EXCELENTE — performance-based, risco no mentor"
    naming: "BOM — 'Operacao Liberdade' evoca transformacao"

  problemas_identificados:
    - priority: HIGH
      issue: "Falta video-depoimento dos 47 cases (so texto)"
      fix: "Gravar 5 video-depoimentos de 60 segundos"
    - priority: MEDIUM
      issue: "Urgencia fraca — 'proxima turma em 4 meses' nao pressiona"
      fix: "Adicionar bonus de early bird com prazo definido"

  veredicto: "APROVADA COM AJUSTES — corrigir top 2 issues antes de lancar"
```

## Veto Conditions
- Avaliacao sem criterios objetivos de scoring
- Ignorar Value Equation na analise
- Aprovar oferta sem diferenciacao clara
