...
- **Prerequisites**: diagnose-awareness.md, create-unique-mechanism.md
- **Used by**: create-sales-page.md, create-vsl.md, create-ad-copy.md
...
executor:
  ...
  rationale: "Gary Bencivenga como mestre da Persuasion Equation e prova irrefutavel, com Claude Hopkins como referencia de especificidade"
```
...
```yaml
pre_conditions:
  - Claims/promessas da oferta definidos (o que precisa ser provado)
  - Acesso a evidencias reais (depoimentos, numeros, cases, credenciais)
  - Nivel de ceticismo do mercado avaliado (diagnostico de sofisticacao)
  - Faixa de preco da oferta definida (high-ticket exige mais proof)
  - Avatar/ICP com objecoes conhecidas
```
...
proof_stack:
  ...
  tier_1_results:
    - type: "Case Study"
      proof: "Agencia Nexus: de R$ 45k/mes para R$ 127k/mes em 4 meses, com dono trabalhando 30h/semana (antes: 65h)"
    - type: "Aggregate Stat"
      proof: "47 agencias atendidas, media de 2.3x crescimento em 6 meses"

  tier_2_credentials:
    - type: "Personal"
      proof: "Ex-dono de agencia que faturou R$ 6.2M em 2024"
    - type: "Social"
      proof: "Palestrante no RD Summit 2025, convidado do podcast Agencia10x"

  tier_3_social:
    - type: "Testimonial"
      proof: "'Eu achava que precisava de mais clientes. O Ricardo me mostrou que eu precisava de processo. Em 3 meses sai de 50k pra 95k.' — Carlos, Agencia Vertice"
    - type: "Screenshot"
      proof: "Print do dashboard mostrando 47 membros ativos na comunidade"

  tier_4_logic:
    - type: "Math Proof"
      proof: "Se sua hora vale R$ 200 e voce gasta 40h/mes em tarefas de R$ 30/hora, perde R$ 6.800/mes. A mentoria se paga em 2 meses."

  deployment_order:
    headline: "Stat agregado (47 agencias)"
    lead: "Case study principal (Nexus)"
    body: "Depoimentos intercalados"
    close: "Math proof + garantia"
```

## Veto Conditions
- Provas nao verificaveis ou fabricadas
- Proof stack sem especificidade (numeros, datas, nomes)
- Ignorar tipos de prova essenciais (social proof, results, credentials)
