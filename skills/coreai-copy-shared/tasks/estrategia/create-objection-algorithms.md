...
- `agents/tier-2-executores/david-ogilvy.md` (objection_algorithms section)
- `agents/tier-1-estrategistas/alex-hormozi.md` (objection_algorithms section)
- `agents/tier-1-estrategistas/dan-kennedy.md` (objection_algorithms section)
...
executor:
  ...
  rationale: "Stefan Georgi domina criacao de algoritmos de objecao com antidotos sistematicos, integrando LAER Model e Kennedy Objection Neutralization"
```
...
```yaml
pre_conditions:
  - Avatar/ICP definido com objecoes reais mapeadas
  - Produto/oferta definido com beneficios e preco claros
  - Materiais-fonte do copywriter disponiveis (se fase de criacao de agente)
  - Pesquisa de mercado com objecoes reais coletadas (reviews, calls, tickets)
  - Garantia e risk reversal definidos (para antidotos de preco/risco)
```
...
objection_algorithms:
  ...
  algorithms:
    - objection: "E muito caro"
      tier: "PRICE"
      iceberg:
        visible: "O preco esta alto demais"
        hidden: "Nao acredito que vou ter retorno"
      algorithm:
        name: "ROI Reversal"
        style: "kennedy"
        response_pattern: |
          "Voce esta certo — R$ 12.000 e muito dinheiro. Mas deixa eu
          te fazer uma pergunta: quanto voce PERDE todo mes ficando
          preso no operacional? Se sua hora vale R$ 200 e voce gasta
          40h/mes em tarefas de R$ 30/hora, esta jogando fora R$ 6.800
          por mes. Em 2 meses o programa se paga."
        trigger_phrase: "Quanto custa NAO resolver isso?"

    - objection: "Preciso pensar"
      tier: "DELAY"
      iceberg:
        visible: "Quero avaliar com calma"
        hidden: "Tenho medo de me arrepender"
      algorithm:
        name: "Cost of Inaction"
        style: "kennedy"
        response_pattern: |
          "Claro, pense com calma. So lembra que 'pensar' e exatamente
          o que voce fez nos ultimos 12 meses — e aqui esta voce,
          na mesma situacao. O que vai mudar em 7 dias de reflexao?"
```

## Veto Conditions
- Objecoes inventadas sem base em pesquisa real
- Antidotos genericos que nao destroem a objecao
- Ignorar objecoes de preco em produtos high-ticket
