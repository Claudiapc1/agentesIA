...
| Field | Value |
|-------|-------|
| **task_name** | Create Big Idea |
| **status** | `active` |
| **responsible_executor** | @todd-brown, @copy-chief |
| **execution_type** | `Interactive` |
| **elicit** | true |

### Veto Conditions
- VETO: Big Idea nao e explicavel em 1 frase simples → REWRITE
- VETO: Big Idea funciona igualmente para concorrente (teste de unicidade) → REWRITE
- VETO: Big Idea sem Unique Mechanism definido → BLOCK
- VETO: Nao passa nos 5 Criteria de Todd Brown (Intellectually Interesting, Emotionally Compelling, Unique and Ownable, Single-Minded, Relevant) → REWRITE
...
optional:
  ...
  - awareness_level: From diagnose-awareness.md (1-5)
  - sophistication_stage: From diagnose-sophistication.md (1-5)
...
- **Prerequisites**: E1 research complete (diagnose-awareness.md, diagnose-avatar.md)
- **Related (deeper)**: create-unique-mechanism.md (full mechanism development)
- **Used by**: create-headlines.md, create-sales-page.md, create-vsl.md, create-ad-copy.md
...
executor:
  ...
  rationale: "Todd Brown como criador do framework de Big Idea com 5 criterios e arquitetura E5 Method"
```
...
```yaml
pre_conditions:
  - Pesquisa E1 (Educate) concluida — entendimento profundo do mercado e avatar
  - Diagnostico de awareness e sofisticacao disponivel
  - Produto/oferta definido com beneficio principal claro
  - Paisagem competitiva mapeada (claims dos concorrentes)
```
...
big_idea:
  ...
  the_big_idea: |
    "Sua agencia nao precisa de mais clientes. Precisa de um sistema
    que ENTREGUE sem voce. O problema nunca foi vendas — foi delivery."

  5_criteria_validation:
    intellectually_interesting: true # Inverte o diagnostico esperado do mercado
    emotionally_compelling: true # Toca o medo de colapsar por excesso de demanda
    unique_and_ownable: true # Ninguem no mercado fala "o problema e delivery, nao vendas"
    single_minded: true # Um conceito so: delivery, nao vendas
    relevant: true # Ligado ao resultado desejado (sair de 50k e chegar a 100k)

  teste_unicidade: |
    Se colocar essa Big Idea no perfil do concorrente, funciona?
    NAO — concorrentes focam em "vender mais" e "escalar faturamento".
    Esta Big Idea inverte o paradigma: o problema e a ENTREGA.

  headline_candidates:
    - "Pare de vender mais. Comece a entregar melhor."
    - "O motivo #1 pelo qual agencias de 50k/mes nao chegam a 100k nao tem NADA a ver com vendas"
    - "Sua agencia esta morrendo de sucesso — e voce ainda nao percebeu"

  emotion: "MEDO (de colapsar por excesso de demanda)"
  nudge: "Urgencia + Oportunidade"

  one_sentence: |
    Escalar uma agencia nao e sobre vender mais — e sobre criar um
    sistema de delivery que funcione sem o dono.
```
