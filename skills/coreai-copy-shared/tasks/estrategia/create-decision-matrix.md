...
decision_matrix_result:
  ...
  first_steps:
    1: "Run diagnose-awareness.md to confirm Level [X]"
    2: "Run diagnose-sophistication.md to confirm Stage [X]"
...
- Fix: Run diagnose-sophistication.md
...
- **Related tasks**: diagnose-awareness.md, diagnose-sophistication.md
...
executor:
  ...
  rationale: "Dan Kennedy como estrategista direto que domina decisao de workflow por tipo de trafego, preco e mercado"
```
...
```yaml
pre_conditions:
  - Produto/servico definido (o que sera vendido)
  - Faixa de preco conhecida (low/mid/high/premium)
  - Fonte de trafego principal identificada (frio, morno, quente)
  - Tipo de output desejado claro (sales page, email, VSL, ad, etc.)
  - Informacoes basicas sobre mercado e concorrencia
```
...
```yaml
decision_matrix:
  project: "Sales Page — Mentoria Elite"
  date: "2026-03-15"

  5_questions:
    1_awareness: "Level 3 — Solution-Aware"
    2_sophistication: "Stage 4 — Tired of Mechanisms"
    3_price_point: "High-ticket (R$ 12.000)"
    4_traffic_source: "Trafego quente — lista de email + Instagram"
    5_output_type: "Sales page longa + sequencia de emails"

  workflow_recommended: "WF-3: Full Funnel (Sales Page + Email Sequence)"
  justificativa: |
    High-ticket + Solution-Aware + Stage 4 exige sales page longa com
    forte proof stack e story-driven lead. Sequencia de emails para
    nurturing antes da pagina.

  configuration:
    lead_type: "Story Lead (Masterson)"
    copy_length: "3000-5000 palavras"
    proof_priority: ["Cases de sucesso", "Numeros especificos", "Garantia forte"]
    big_idea_style: "Identity-driven (Stage 4)"

  next_step: "Executar WF-3 comecando por create-big-idea.md"
```

## Veto Conditions
- Matriz sem as 5 perguntas obrigatorias (awareness, sofisticacao, preco, trafego, output)
- Recomendacao de workflow sem justificativa
