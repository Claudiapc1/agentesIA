...
| **status** | `active` |
| **responsible_executor** | @alex-hormozi, @copy-chief |
| **execution_type** | `Interactive` |
| **elicit** | true |

### Veto Conditions
- VETO: Oferta sem Value Equation preenchida (Dream Outcome, Likelihood, Time Delay, Effort) → BLOCK
- VETO: Preco nao justificado por value stack → REWRITE
- VETO: Sem garantia definida → BLOCK
- VETO: Oferta que nao cria "categoria de um" (anti-commoditization) → REWRITE
...
executor:
  ...
  rationale: "Alex Hormozi como criador do Grand Slam Offer Framework e Value Equation para ofertas irresistiveis"
```
...
```yaml
pre_conditions:
  - Produto/servico definido (o que sera entregue)
  - Avatar/ICP com dores e desejos claros
  - Faixa de preco pretendida (para justificacao via value stack)
  - Dream Outcome do cliente identificado
  - Concorrentes e suas ofertas mapeados (para anti-commoditization)
```
...
```yaml
offer:
  name: "Mentoria Elite — Operacao Liberdade"
  price: "R$ 12.000 (ou 12x R$ 1.197)"
  date: "2026-03-15"

  value_equation:
    dream_outcome: "Agencia faturando 100k+/mes rodando sem o dono"
    perceived_likelihood: "ALTA — 47 cases documentados"
    time_delay: "90 dias para primeiros resultados"
    effort_required: "BAIXO — 2h/semana de implementacao guiada"
    value_score: 8.5/10

  value_stack:
    core: "12 semanas de mentoria em grupo (valor: R$ 18.000)"
    bonus_1: "Sprint de Delegacao — template completo (valor: R$ 3.000)"
    bonus_2: "Pack de SOPs prontos para agencia (valor: R$ 5.000)"
    bonus_3: "2 hot seats individuais de 30min (valor: R$ 4.000)"
    bonus_4: "Comunidade vitalicia no Skool (valor: R$ 2.400/ano)"
    total_valor_percebido: "R$ 32.400"
    preco_real: "R$ 12.000"
    ratio: "2.7x (paga R$ 1 leva R$ 2.70)"

  guarantee:
    type: "Performance-based"
    promise: "Se nao sair do operacional em 90 dias, fica mais 90 dias gratis"
    risk_reversal: "TOTAL — risco esta no mentor, nao no aluno"

  scarcity: "Turma limitada a 20 agencias (por capacidade de acompanhamento)"
  urgency: "Proxima turma so em 4 meses"
  naming: "Operacao Liberdade (evoca a transformacao desejada)"
```
