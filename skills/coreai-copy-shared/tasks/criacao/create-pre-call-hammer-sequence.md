...
| Field | Value |
|-------|-------|
| **executor** | andre-chaperon |

## Pre-Conditions
- Premissa-core.md carregada
- Oferta e preco do high-ticket definidos
- Show rate atual e tempo entre agendamento e call conhecidos
- Objecoes e perguntas mais frequentes nas calls mapeadas
- Conteudo de suporte disponivel (VSL, testimonials, case studies)
...
## Veto Conditions
- Nao criar sequencia pre-call sem oferta e preco do high-ticket definidos
- Nao executar sem conhecer o show rate atual e tempo entre agendamento e call
- Nao produzir sem mapear as objecoes e perguntas mais frequentes nas calls
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
PRE-CALL HAMMER — Mentoria Elite (R$12.000)
Dia entre agendamento e call | 6 emails
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

EMAIL 1/6 — Confirmacao + Expectativa (Hora 0)
Subject: sua call esta confirmada — leia isso antes

[NOME], parabens por agendar.

Sua call e [DIA] as [HORA].

Antes de falar com voce, quero que voce veja
este video de 7 minutos:
→ [LINK VSL CURTA]

Nele eu explico o sistema que usamos pra levar
empreendedores de R$30k pra R$100k+/mes
sem lancamento.

Isso vai fazer nossa conversa render 3x mais.

[Nome]

---

EMAIL 3/6 — Case Study (Hora 8)
Subject: o Marcos faturava R$12k... olha agora

[NOME],

Antes da call de amanha, queria te apresentar o Marcos.

Quando ele chegou: R$12k/mes, 14h/dia, 3 lancamentos fracassados.
90 dias depois: R$340k/mes, 5h/dia, zero lancamento.

O que mudou? Ele instalou 3 sistemas:
1. Funil de conversao em 72h
2. Automacao de nutrição
3. Ascensao de ticket

Na nossa call eu vou analisar seu negocio
e te mostrar quais desses 3 voce precisa primeiro.

→ Veja o depoimento completo do Marcos: [LINK]

[Nome]

---

EMAIL 6/6 — Dia da Call (30 min antes)
Subject: daqui 30 minutos — ta pronto?

[NOME], sua call e em 30 minutos.

Link: [LINK ZOOM]

3 coisas pra ter em mente:
1. Me conta seu faturamento atual e meta
2. Me diz seu maior gargalo hoje
3. Seja honesto — nao estou aqui pra vender, estou pra diagnosticar

Se fizer sentido pra voce E pra mim, eu apresento
a Mentoria Elite. Se nao fizer, eu te dou 3 acoes
praticas pra implementar sozinho.
