...
task:
  ...
  pre_conditions:
    ...
    - "Oferta, headline principal e CTA definidos"
    - "Fonte de trafego conhecida (paid, organic, email)"
```

---

## Veto Conditions
- Nao criar landing page sem diagnostico de awareness level do trafego que vai receber
- Nao executar sem oferta, headline principal e CTA definidos
- Nao produzir sem saber a fonte de trafego (paid, organic, email) para alinhar a mensagem
...
sales_page:
  ...
  note: "Ver tasks/criacao/create-sales-page.md para estrutura completa"
