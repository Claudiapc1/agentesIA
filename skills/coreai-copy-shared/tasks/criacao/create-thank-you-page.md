...
| Field | Value |
|-------|-------|
| **executor** | russell-brunson |

## Pre-Conditions
- Premissa-core.md carregada
- Acao que originou a thank you page conhecida (compra, opt-in, webinar)
- Proximo passo estrategico definido (OTO, onboarding, referral)
- Elementos de confirmacao e reducao de buyer's remorse preparados
- Oferta de OTO/upsell pronta (se aplicavel)
...
## Veto Conditions
- Nao criar thank you page sem conhecer a acao que a originou (compra, opt-in, webinar)
- Nao executar sem definir proximo passo estrategico (OTO, onboarding, referral)
- Nao produzir sem elementos de confirmacao e reducao de buyer's remorse
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
THANK YOU PAGE — Pos-compra Programa Acelerador Digital
Tipo: Compra + OTO
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

SECAO 1 — CONFIRMACAO:
Headline: Parabens, [NOME]! Voce esta dentro do
Programa Acelerador Digital! ✅

Sub: Seu acesso sera liberado em ate 15 minutos.
Verifique seu email ([EMAIL]) para as instrucoes.

SECAO 2 — REDUCAO DE BUYER'S REMORSE:
"Voce acabou de tomar uma das melhores decisoes
do seu negocio. 200+ empreendedores ja passaram
por esse mesmo momento — e em media, o retorno
do investimento vem em 47 dias."

Video curto (90 segundos): Boas-vindas pessoal
do mentor + o que esperar nos primeiros 7 dias.

SECAO 3 — PROXIMOS PASSOS:
1. Verifique seu email (acesso em 15 min)
2. Entre no grupo de implementacao [LINK]
3. Assista a Aula 0: "Seu Plano de 90 Dias" [LINK]
4. Agende sua sessao 1:1 de diagnostico [LINK CALENDLY]

SECAO 4 — OTO (One Time Offer):
Headline: OFERTA EXCLUSIVA — So aparece agora

"Quer implementar 3x mais rapido?
Adicione o Pacote VIP com 4 sessoes individuais
de implementacao por apenas R$997 (valor normal: R$3.000)."

Beneficios VIP:
→ 4 calls individuais de 45 min (1 por semana)
→ Revisao pessoal do seu funil
→ Acesso direto via WhatsApp por 30 dias

[ADICIONAR PACOTE VIP — R$997]

Timer: Esta oferta expira em 15:00 minutos

SECAO 5 — REFERRAL:
"Conhece alguem que precisa disso?
Compartilhe e ganhe 30 dias extras de comunidade."
[COMPARTILHAR NO WHATSAPP] [COMPARTILHAR NO EMAIL]
```
