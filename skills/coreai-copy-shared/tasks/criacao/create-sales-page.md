...
| Field | Value |
|-------|-------|
| **task_name** | Create Sales Page |
| **status** | `active` |
| **responsible_executor** | @gary-halbert, @stefan-georgi, @copy-chief |
| **execution_type** | `Hybrid` |
| **elicit** | true |

### Veto Conditions
- VETO: Sem diagnostico de awareness level → BLOCK (run diagnose-awareness first)
- VETO: Sem Big Idea definida → BLOCK (run create-big-idea first)
- VETO: Sem proof stack de minimo 6 tipos obrigatorios → BLOCK
- VETO: Lead type incompativel com awareness level → REWRITE
...
task:
  ...
  pre_conditions:
    ...
    - "Offer estruturada (create-offer executado)"
    - "Market sophistication diagnosticado (diagnose-sophistication executado)"
  dependencies:
    - diagnose-awareness.md
    - diagnose-sophistication.md
    - create-headlines.md
  checklists:
...
**EXECUTE:** task diagnose-awareness.md
...
**EXECUTE:** task diagnose-sophistication.md
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SALES PAGE — Programa Acelerador Digital
Awareness: Solution Aware | Lead Type: Story
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

SECAO 1 — PRE-HEADLINE + HEADLINE:
Pre-headline: Para empreendedores digitais que faturam
entre R$10k e R$50k/mes e querem previsibilidade

Headline: O Sistema de 3 Etapas Que Transformou
Empreendedores Travados em R$30k/Mes Em Negocios
de R$100k+ No Automatico — Sem Lancamento,
Sem Equipe Grande e Sem Trabalhar Mais

Sub-headline: 200+ empreendedores ja instalaram.
Tempo medio de resultado: 47 dias.

SECAO 2 — LEAD (Story):
"Em janeiro de 2021, eu olhei pro meu extrato bancario
e senti o estomago afundar.

R$1.2 milhao tinha entrado na conta 60 dias antes.
E agora eu tinha R$23 mil. Vinte e tres mil reais.

Nao porque gastei em besteira.
Mas porque meu negocio inteiro dependia de UMA
semana de lancamento por trimestre.

E quando o lancamento nao vinha... o dinheiro
tambem nao."

SECAO 3 — PROBLEMA/VILAO:
"O modelo de lancamento foi desenhado pra funcionar
pra PLATAFORMAS — nao pra voce.

Enquanto voce trabalha 3 meses pra faturar em 1 semana,
a plataforma cobra taxa em cada transacao.
A agencia cobra o fee todo mes.
O gestor de trafego cobra mesmo quando da prejuizo."

SECAO 4 — MECANISMO UNICO:
"O Sistema Perpetuo de Conversao funciona em 3 etapas..."

SECAO 5 — OFFER STACK:
✅ 8 Modulos (32 aulas praticas) — Valor: R$4.997
✅ 12 Calls de Grupo ao Vivo — Valor: R$2.997
✅ Comunidade de Implementacao — Valor: R$1.997
✅ Kit de 47 Templates — Valor: R$997
✅ BONUS: Sessao 1:1 de Diagnostico — Valor: R$1.500
Total: R$12.488
Investimento: R$2.997 ou 12x R$297

SECAO 6 — CTA + GARANTIA:
Garantia de 15 dias. Implementou e nao gostou? 100% de volta.
[QUERO MINHA VAGA NO ACELERADOR DIGITAL]
```

## Validacao Obrigatoria (automatica pos-criacao)

**NENHUMA copy e entregue sem passar por esta validacao. Automatica. Sem excecao.**
...
step_final:
  ...
  sequence:
    - step: "V1"
      ...
      resultado: "Qualquer violacao = REPROVADA instantaneamente"
    - step: "V2"
  ...
  on_fail: "Reescrever e validar novamente ate aprovacao"
  on_pass: "Entregar com selo APROVADO ORACULO 10/10"
```
