...
task:
  ...
  pre_conditions:
    ...
    - "Big Idea ou angulo de diferenciacao definido"
    - "Destino da headline definido (ad, email, sales page)"
```

---

## Veto Conditions
- Nao criar headlines sem diagnostico de awareness level (Schwartz) do publico
- Nao gerar sem big idea ou angulo de diferenciacao definido
- Nao executar sem conhecer a oferta e o destino da headline (ad, email, sales page)
