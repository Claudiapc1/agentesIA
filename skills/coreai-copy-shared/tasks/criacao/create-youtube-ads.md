...
- CTA e destino do clique (landing page, lead magnet) definidos
- Hook que funcione antes do botao Skip (primeiros 5 segundos) planejado
- Formato do ad definido (In-Stream, Shorts, Bumper, Discovery)
...
## Veto Conditions
- Nao criar YouTube ad sem hook que funcione antes do botao Skip (primeiros 5 segundos)
- Nao executar sem CTA e destino do clique (landing page, lead magnet) definidos
- Nao produzir sem avatar e nivel de consciencia para calibrar o tom do script
...
- **VSL Task:** `tasks/criacao/create-vsl.md`
- **Video Hook Task:** `tasks/criacao/create-video-hook.md`
- **Landing Page Task:** `tasks/criacao/create-landing-page.md`
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
YOUTUBE AD SCRIPT — Programa Acelerador Digital
Formato: In-Stream Skippable | Duracao: 60 segundos
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

PRE-SKIP HOOK (0-5 segundos):
[Presenter falando rapido, energia alta]
"Se voce fatura menos de R$50k por mes com
marketing digital — NAO pula esse anuncio.
Nos proximos 45 segundos eu vou te mostrar
por que voce esta travado."

BRANDING + AUTORIDADE (5-15s):
"Meu nome e [Nome]. Nos ultimos 3 anos eu ajudei
200+ empreendedores a sair de R$10-30k/mes
para R$100k+ usando um sistema que funciona
TODOS os dias — sem lancamento."

CONTEUDO / VALOR (15-40s):
"O erro numero 1 e achar que voce precisa
de mais trafego. Voce nao precisa.
Voce precisa de um SISTEMA que converte
o trafego que voce ja tem.

Deixa eu te dar um numero:
Nossos alunos convertem em media 3.2x mais
depois de instalar o Funil de 72 Horas.

Isso significa que com O MESMO gasto de trafego,
eles faturam 3x mais."

CTA (40-60s):
"Eu criei uma masterclass gratuita de 47 minutos
que mostra exatamente como esse sistema funciona.

Clique no link abaixo ou no botao 'saiba mais'
pra assistir agora. E gratuito. E pode mudar
o jogo do seu negocio."

[END CARD: Thumbnail da masterclass + botao CTA]

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
HOOKS ALTERNATIVOS (primeiros 5 segundos):
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Hook 2: "Eu gastei R$47 mil em anuncios ate descobrir
que o problema nao era o trafego."
Hook 3: "3 coisas que todo empreendedor digital de
6 digitos faz — e voce provavelmente nao faz nenhuma."
```
