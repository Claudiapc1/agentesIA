...
executor: michael-masterson
tier_0_required: true
minimum_output: 5 deliverables
estimated_time: 2-4 hours
pre_conditions:
  - "Premissa-core.md carregada"
  - "Avatar e dor principal claramente mapeados (diagnose-avatar executado)"
  - "Awareness level diagnosticado (diagnose-awareness executado)"
  - "Ponte entre lead magnet e oferta paga definida"
  - "Formato do lead magnet escolhido (checklist, guia, template, quiz)"
```
...
## Veto Conditions
- Nao criar lead magnet sem avatar e dor principal claramente mapeados
- Nao executar sem definir a ponte entre o lead magnet e a oferta paga
- Nao produzir sem diagnostico de awareness level do publico-alvo
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
LEAD MAGNET — Checklist "Diagnostico de Funil"
Produto ponte: Programa Acelerador Digital (R$2.997)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

NOME: "Os 7 Buracos Que Drenam Seu Faturamento
       (Checklist de Diagnostico do Funil)"

TIPO: Checklist interativo (PDF, 3 paginas)

PROMESSA: Em 10 minutos, identifique exatamente
onde seu funil esta vazando dinheiro — e quanto
voce esta perdendo por mes.

ESTRUTURA:
Pagina 1 — Diagnostico (7 perguntas com scoring)
  □ Seu lead magnet converte acima de 35%?
  □ Sua sequencia de email tem mais de 3 emails?
  □ Voce tem um mecanismo de conversao alem da pagina de vendas?
  □ Seu ROAS esta acima de 3:1?
  □ Voce vende todos os dias (nao so em lancamento)?
  □ Seu ticket medio esta acima de R$500?
  □ Voce tem upsell/order bump ativo?

Pagina 2 — Diagnostico (resultados)
  0-2 "sim": Funil critico — voce esta perdendo +R$30k/mes
  3-4 "sim": Funil fragil — oportunidade de 2-3x no faturamento
  5-7 "sim": Funil solido — otimizacao pode gerar +50%

Pagina 3 — Proximo passo
  "Se voce marcou menos de 5, o Programa Acelerador Digital
   conserta cada um desses buracos em 8 semanas.
   → [LINK PARA PAGINA DE VENDAS]"

PONTE PARA OFERTA PAGA:
Lead magnet diagnostica → resultado mostra gaps →
CTA natural para o programa que resolve os gaps.
```
