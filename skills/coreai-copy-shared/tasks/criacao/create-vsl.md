> DUPLICATA SEMÂNTICA: canônico é `tasks/criacao/create-vsl.md` (referenciado em `dependencies.tasks` e `templates/vsl-script-tmpl.md` no copy-chief.md). Este arquivo cobre o mesmo domínio com redação diferente — consultar o canônico primeiro.
...
| Field | Value |
|-------|-------|
| **task_name** | Create VSL Script |
| **status** | `active` |
| **responsible_executor** | @jon-benson, @todd-brown, @copy-chief |
| **execution_type** | `Interactive` |
| **executor** | jon-benson |
| **elicit** | true |

### Veto Conditions
- VETO: Sem Big Idea definida → BLOCK
- VETO: Sem One Belief claro → BLOCK (run diagnose-one-belief)
- VETO: Script sem hook nos primeiros 15 segundos → REWRITE
- VETO: Sem proof stack integrado no corpo → REWRITE
- VETO: CTA nao aparece ate o ultimo 1/3 do script sem justificativa → REVIEW
...
sources_read:
  ...
  - path: "agents/tier-2-executores/jon-benson.md"
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
VSL SCRIPT — Programa Acelerador Digital
Formato: Text-on-screen | Duracao: 25 min
Estrutura: 3X Formula (Jon Benson)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

ABERTURA / HOOK (0:00-0:45):
"Atenção, empreendedor digital.

Se você fatura entre R$10 mil e R$50 mil por mês...
e está preso no ciclo de lançamento...

Nos próximos 25 minutos eu vou te mostrar
o sistema de 3 etapas que transformou 200+
empreendedores travados em negócios de
R$100 mil por mês — no automático.

Sem lançamento. Sem equipe grande.
Sem trabalhar mais do que você já trabalha.

Mas primeiro, preciso te contar uma história
que quase ninguém sabe..."

STORY / LEAD (0:45-5:00):
"Em janeiro de 2021, eu olhei pro meu extrato
bancário e senti o estômago afundar.

R$1.2 milhão tinha entrado na conta 60 dias antes.
E agora eu tinha R$23 mil..."

[Continua com história de origem, crise,
e descoberta do sistema perpetuo]

PROBLEMA / VILÃO (5:00-10:00):
"A indústria de lançamentos quer que você acredite
que o único caminho é..."

[Expoe o modelo de lancamento como vilao,
mostra dados reais de fracasso]

SOLUÇÃO / MECANISMO (10:00-15:00):
"O Sistema Perpétuo de Conversão funciona em 3 etapas:
Etapa 1: Funil de Conversão em 72h...
Etapa 2: Automação de Nutrição...
Etapa 3: Ascensão de Ticket..."

PROVA (15:00-20:00):
"O Marcos chegou faturando R$12k/mês...
90 dias depois: R$340k..."
[3 cases + screenshots + dados]

OFERTA + CTA (20:00-25:00):
"O Programa Acelerador Digital inclui...
