...
- Lista de beneficios concretos e provas do produto disponivel
- Nivel de sofisticacao do mercado diagnosticado (diagnose-sophistication executado)
- Contexto de uso definido (VSL, email, sales page)

## Veto Conditions
- Nao criar bullets sem lista de beneficios concretos e provas do produto
- Nao gerar fascinations sem conhecer o nivel de sofisticacao do mercado
- Nao executar sem contexto de onde os bullets serao usados (VSL, email, sales page)
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
BULLETS — Programa Acelerador Digital
Contexto: Sales Page | Secao de Modulos
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

FASCINATIONS (Curiosidade + Beneficio):

• O "atalho dos 72 horas" que transforma trafego frio em
  cliente pagante — sem webinar, sem ligacao, sem follow-up
  manual (Modulo 3, Aula 2)

• Por que 93% dos empreendedores digitais NUNCA passam de
  R$30k/mes — e o ajuste de 15 minutos que muda isso
  (pagina 47 do workbook)

• A sequencia de 5 emails que gerou R$2.3 milhoes em 12 meses
  para um expert que nao aparecia em video (template incluso)

• O erro fatal que voce comete toda vez que sobe um anuncio
  — e que esta queimando ate 60% do seu orcamento de trafego

• Como uma mentora de nutricao saiu de R$8k/mes para R$127k/mes
  em 90 dias usando apenas UMA fonte de trafego

• A "regra do balde furado": por que escalar trafego sem isso
  e como jogar dinheiro no lixo (e como consertar em 48 horas)

• O framework de precificacao que fez 3 alunos dobrarem o ticket
  medio sem perder nenhum cliente (ao contrario — ganharam mais)
```
