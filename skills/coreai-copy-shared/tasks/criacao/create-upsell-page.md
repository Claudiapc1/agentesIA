...
pre_conditions:
  ...
  - "Produto principal ja comprado pelo cliente conhecido"
  - "Upsell que complementa/acelera o resultado do produto core definido"
  - "Preco posicionado estrategicamente em relacao a compra anterior"
  - "Pagina de vendas/checkout do produto principal ja criada"
```
...
## Veto Conditions
- Nao criar upsell sem conhecer o produto principal ja comprado pelo cliente
- Nao executar sem definir como o upsell complementa/acelera o resultado do produto core
- Nao produzir sem preco posicionado estrategicamente em relacao a compra anterior
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
UPSELL PAGE — Pacote Implementacao VIP
Produto core comprado: Acelerador Digital (R$2.997)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

HEADLINE:
Espera, [NOME] — Antes De Acessar Seu Programa...
Quer Implementar Em 30 Dias O Que A Maioria
Leva 6 Meses? (Oferta Unica — So Aparece Agora)

SUB-HEADLINE:
Adicione o Pacote Implementacao VIP e tenha
acompanhamento individual para instalar o sistema
completo no seu negocio.

CORPO:
Voce acabou de fazer uma decisao inteligente.

Mas eu vou ser honesto com voce:

O Programa Acelerador Digital funciona. 200+ alunos provam isso.
Mas os alunos que implementam MAIS RAPIDO tem uma coisa em comum:

Acompanhamento individual.

Os alunos com Pacote VIP implementam em media
em 30 dias. Os alunos sem VIP levam 90-120 dias.

OFFER STACK:
✅ 8 sessoes individuais de 45 min (valor: R$6.000)
✅ Revisao completa do seu funil (valor: R$2.000)
✅ Acesso direto via WhatsApp por 60 dias (valor: R$1.500)
✅ Templates customizados pro seu nicho (valor: R$997)
Total: R$10.497

Seu investimento UNICO (so nesta pagina): R$1.997
Ou 12x de R$197

GARANTIA:
Se em 30 dias voce nao tiver o sistema rodando,
eu continuo te acompanhando DE GRACA ate funcionar.

CTA:
[SIM! QUERO O PACOTE VIP POR R$1.997]

RECUSA:
"Nao, obrigado. Prefiro implementar sozinho."
