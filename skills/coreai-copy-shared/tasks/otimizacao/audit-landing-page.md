...
## Pre-Conditions
- URL da landing page acessivel e funcionando
- Produto, preco e CTA principal definidos
- Fonte de trafego identificada (paid, organic, email, social)
- Tipo de pagina classificado (VSL, long-form, short-form, webinar, lead-magnet)

## Output Example

```yaml
landing_page_audit:
  url: "mentoriaelite.com.br/inscricao"
  score: 67/100
  date: "2026-03-15"

  meclabs_heuristic:
    motivation: 7/10 # Headline forte, mas hero section confusa
    value_proposition: 6/10 # Proposta clara so no segundo scroll
    incentive: 5/10 # Bonus listados mas sem valor percebido
    friction: -4/10 # Formulario com 8 campos (demais)
    anxiety: -3/10 # Sem selo de seguranca, sem LGPD visivel

  hormozi_value:
    dream_outcome: 8/10
    perceived_likelihood: 5/10 # Falta prova visual
    time_delay: 7/10
    effort_required: 4/10 # Processo de inscricao parece trabalhoso

  issues_prioritized:
    - priority: P0
      section: "Above the fold"
      issue: "CTA nao visivel sem scroll no mobile"
      fix: "Mover botao para dentro da hero section"
      impact_estimado: "+15-25% conversao"

    - priority: P1
      section: "Formulario"
      issue: "8 campos matam conversao (benchmark: 3-4 campos)"
      fix: "Reduzir para Nome + Email + WhatsApp"
      impact_estimado: "+30-50% form completion"

    - priority: P2
      section: "Social proof"
      issue: "Depoimentos em texto sem foto"
      fix: "Adicionar foto + cargo + resultado numerico"

  ab_tests_sugeridos:
    1: "Headline A (problema) vs B (resultado) — medir CTR do CTA"
    2: "Form 8 campos vs 3 campos — medir completion rate"
    3: "Com video vs sem video na hero — medir time on page"
```

## Veto Conditions
- Auditoria sem analise de fluxo de conversao completo
- Ignorar mobile responsiveness na avaliacao
- Aprovar pagina sem CTA claro above the fold
