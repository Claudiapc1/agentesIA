...
## Pre-Conditions
- Briefing ativo ou peca de copy para debater
- 2 a 4 copywriter personas selecionados com filosofias distintas
- Objetivo claro do debate (escolher abordagem, diagnosticar problema, otimizar)
- Criterios de avaliacao definidos antes do debate

## Output Example

```markdown
# Debate: Melhor Lead para Sales Page — Mentoria Elite

## Participantes
- **Gary Halbert** — defende Story Lead
- **Eugene Schwartz** — defende Secret Lead
- **Dan Kennedy** — defende Offer Lead

## Round 1: Abertura

**Halbert:** "Comece com historia. Conte como voce quase fechou a agencia.
Vulnerabilidade VENDE. Ninguem resiste a uma boa historia de queda e superacao."

**Schwartz:** "O mercado esta em Stage 4. Stories ja foram exploradas.
Use um segredo — algo que eles NAO sabem. 'O erro invisivel que impede
agencias de 50k de chegar a 100k.'"

**Kennedy:** "Vao direto pra oferta. Esse publico e Solution-Aware.
Eles sabem que precisam de mentoria. Parem de enrolar e mostrem o deal."

## Sintese do Copy Chief

**Veredicto:** Story Lead (Halbert) com elemento de segredo (Schwartz).

**Justificativa:** Em Stage 4, stories se destacam quando contem um insight
novo. Combinar historia pessoal + revelacao de um erro desconhecido cria
a melhor abertura. Offer Lead (Kennedy) fica para o email de fechamento.

**Copy recomendada:** Historia dos 3 primeiros paragrafos revelando
"o erro que quase me custou R$ 500k/mes de faturamento."
```

## Veto Conditions
- Debate sem criterios objetivos de avaliacao
- Comparacao entre copys de categorias diferentes
- Veredito sem justificativa tecnica
