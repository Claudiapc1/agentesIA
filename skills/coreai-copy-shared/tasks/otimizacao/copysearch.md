...
- `data/reference/copysearch-anti-hallucination.md` — Anti-hallucination protocols
- `data/reference/copysearch-quick-reference.md` — Quick reference cards
- `data/reference/copysearch-tool-stack.md` — Tool recommendations
...
## Pre-Conditions
- Decisao de negocio especifica que a pesquisa deve informar
- Produto/servico definido com documentacao tecnica disponivel
- Acesso a fontes de Voice of Customer (reviews, tickets, transcricoes)
- Concorrentes identificados (minimo 3 diretos)
- Responsavel humano pela accuracy da pesquisa designado

## Output Example

```yaml
copysearch_output:
  project: "Sales Page — Mentoria de Escala para Agencias"
  date: "2026-03-15"

  technical_fact_sheet:
    anchor_fact: "87% dos donos de agencia trabalham 55+ horas/semana (pesquisa RD Station 2025)"
    facts:
      - "Mercado de agencias digitais no Brasil: R$ 18.7 bilhoes (2025)"
      - "Churn medio de agencias: 15% ao trimestre"
      - "Custo de contratar gerente: R$ 8-15k/mes + encargos"
      - "Tempo medio para burnout: 2.3 anos sem processo"

  consumer_language_bank:
    quotes_collected: 54
    top_phrases:
      - "Minha agencia sou eu. Se eu parar, tudo para."
      - "Faturamento subiu, lucro caiu. Nao faz sentido."
      - "Ja tentei delegar 3 vezes. Sempre volta pior."

  competitive_intelligence:
    concorrentes_analisados: 6
    gap_principal: "Ninguem fala de DELIVERY. Todos focam em 'vender mais'."
    swipe_references:
      - "Agencia10x — bom uso de cases, fraco em mecanismo"
      - "ScaleUp Mentoria — headline forte, oferta fraca"

  strategic_brief:
    positioning: "O anti-guru que foca em processo, nao em promessa vazia"
    proposition: "Saia do operacional em 90 dias sem contratar gerente"
    headlines_gerados: 27
    top_3:
      - "O erro de R$ 6.800/mes que 87% dos donos de agencia cometem sem perceber"
      - "47 agencias ja fizeram isso. Nenhuma voltou pro operacional."
      - "Pare de vender mais. Comece a entregar melhor."
```

## Veto Conditions
- Pesquisa sem fontes verificaveis de swipe files
- Copiar copy de concorrente sem adaptacao original
- Ignorar contexto de mercado na analise de referencias
