...
## Pre-Conditions
- Research completa sobre produto/servico (material fonte disponivel)
- Avatar do cliente definido com dores e desejos mapeados
- Material fonte acessivel (livro, curso, produto) para mineracao de bullets
- Objetivo claro de uso dos bullets (sales page, email, VSL)

## Output Example

```yaml
lampropoulos_bullets:
  ...
  bullets_por_categoria:
    blind_fascination:
      - "O erro de 3 minutos que custa R$ 6.800/mes para 87% dos donos de agencia (pagina 14)"
      - "A pergunta que um CEO de R$ 2M/ano faz toda segunda-feira as 8h — e que muda TUDO na semana (pagina 47)"

    how_to:
      - "Como sair de 80% das entregas da sua agencia em 14 dias — sem contratar gerente e sem perder qualidade"
      - "Como transformar um estagiario de R$ 1.500 em executor de R$ 8.000 usando apenas 3 documentos"

    if_then:
      - "Se voce trabalha mais de 50h/semana na sua agencia e ainda se sente devendo entrega — a resposta esta na pagina 23"
      - "Se ja tentou delegar e 'voltou pior' — o problema NAO e sua equipe (descubra o que e na pagina 31)"

    contrarian:
      - "Por que os donos de agencia que MAIS faturam sao os que MENOS trabalham — e o que sabem que voce nao sabe"
      - "A razao contraintuitiva pela qual vender MAIS pode DESTRUIR sua agencia (e o ponto exato onde isso acontece)"

    proof:
      - "Como a Agencia Nexus saiu de R$ 45k/mes para R$ 127k/mes em 4 meses — com o dono trabalhando 30h/semana MENOS"

  bullets_selecionados_top_10:
    - "O erro de 3 minutos que custa R$ 6.800/mes..."
    - "Como sair de 80% das entregas em 14 dias..."
    # [+ 8 mais]
```

## Veto Conditions
- Bullets genericos sem curiosity gap
- Falta de especificidade (numeros, detalhes concretos)
- Bullets que revelam o segredo (matam a curiosidade)
