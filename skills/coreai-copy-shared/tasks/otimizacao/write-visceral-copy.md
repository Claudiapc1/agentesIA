...
## Pre-Conditions
- Copy original existente (qualquer formato: sales page, email, ad)
- Descricao do publico-alvo com perfil emocional
- Produto/oferta sendo vendido definido
- Resposta emocional desejada especificada
- Guidelines de brand voice (se existirem)

## Output Example

```yaml
visceral_transformation:
  copy: "Abertura da Sales Page — Mentoria Elite"
  date: "2026-03-15"

  dominant_resident_emotion: "Exaustao + Medo de colapso"

  before_after:
    antes: |
      Voce trabalha muitas horas na sua agencia e nao consegue delegar.
      Nosso programa ajuda donos de agencia a sair do operacional
      e ter mais tempo livre.

    depois: |
      Sexta-feira, 22h47. Voce ainda esta sentado na frente do computador.
      Os olhos ardem. O celular vibra — mais um cliente cobrando.

      Sua esposa ja desistiu de perguntar que horas voce vai jantar.
      Seu filho parou de chamar pra brincar. Ele aprendeu que
      "o pai esta trabalhando" e a resposta padrao.

      Voce construiu uma agencia de sucesso. So esqueceu de
      construir uma vida junto.

      E o pior? Voce SABE que nao precisa ser assim.
      Sabe que existe um jeito melhor. Sente no peito.
      Mas toda segunda-feira o ciclo recomeça.

  emotion_audit:
    sensory_words_added: 12 # "ardem", "vibra", "sente no peito"
    pain_agitation: "3 camadas (profissional → familiar → existencial)"
    future_pacing: "Implicito — 'nao precisa ser assim'"
    visceral_score: 9/10

  makepeace_checklist:
    gut_punch: true # "Seu filho parou de chamar pra brincar"
    movie_in_the_mind: true # Cena visual completa
    dominant_emotion_honored: true # Exaustao em cada frase
```

## Veto Conditions
- Copy visceral sem base emocional real do prospect
- Exagero emocional que beira manipulacao
- Ignorar Dominant Resident Emotion (Makepeace)
