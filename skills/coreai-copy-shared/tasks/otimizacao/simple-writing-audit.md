...
## Pre-Conditions
- Copy completa para auditoria (texto integral)
- Contexto do produto/servico disponivel
- Avatar/publico-alvo definido
- Objetivo da copy claro (vendas, leads, etc.)

## Output Example

```yaml
carlton_audit:
  copy: "Pagina de vendas — Programa Acelerador Digital"
  date: "2026-03-15"

  first_impression:
    clarity: 5/10
    conversational: 4/10
    verdict: "Parece copy de MBA, nao de humano"

  issues_found:
    - rule: "Uma ideia por frase"
      count: 14 violacoes
      worst_example:
        antes: "Nosso programa de aceleracao digital visa capacitar empreendedores digitais atraves de metodologias comprovadas que combinam estrategia de conteudo, automacao de funil e otimizacao de conversao"
        depois: "Voce vai aprender a criar um curso. Montar um funil. E vender no automatico."

    - rule: "Escreva como fala"
      count: 8 violacoes
      worst_example:
        antes: "A metodologia proprietaria de validacao antecipada"
        depois: "Um jeito simples de testar se alguem quer comprar ANTES de voce criar qualquer coisa"

    - rule: "Elimine jargao"
      count: 11 termos
      lista: ["metodologia proprietaria", "capacitar", "otimizacao", "framework", "mindset", "escalar", "alavancagem", "pipeline", "stakeholder", "deliverables", "sinergia"]
      substituicoes: ["metodo", "ensinar", "melhorar", "sistema", "mentalidade", "crescer", "usar melhor", "processo", "envolvidos", "entregas", "trabalho conjunto"]

  score:
    antes: "8th grade reading level"
    depois: "4th grade reading level"
    carlton_verdict: "AGORA parece gente falando — nao empresa tentando impressionar"
```

## Veto Conditions
- Auditoria que adiciona complexidade em vez de simplificar
- Ignorar regras de Carlton (uma ideia por frase)
- Aprovar copy com jargao tecnico desnecessario
