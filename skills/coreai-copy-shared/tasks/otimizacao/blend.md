...
- `audit-copy.md` - Validate blended copy quality
...
## Pre-Conditions
- 2 a 4 copywriters selecionados para o blend
- Communication DNA extraido dos copywriters escolhidos (via extract-communication-dna)
- Briefing claro com objetivo, publico e tom desejado
- Copy draft ou briefing para aplicar o blend
...
blend_result:
  ...
  blend_recipe:
    copywriter_1:
      name: "Gary Halbert"
      contribution: 40%
      elements: ["Story lead", "Conversational tone", "Urgencia visceral"]
    copywriter_2:
      name: "David Ogilvy"
      contribution: 35%
      elements: ["Credibilidade", "Dados especificos", "Headline research-based"]
    copywriter_3:
      name: "Dan Kennedy"
      contribution: 25%
      elements: ["Direct response CTA", "Exclusividade", "Anti-commodity positioning"]

  voice_profile:
    assertiveness: 8/10 # Kennedy + Halbert
    warmth: 6/10 # Halbert humaniza
    sophistication: 7/10 # Ogilvy eleva
    directness: 9/10 # Todos diretos

  sample_paragraph: |
    Deixa eu te contar uma coisa que ninguem no mercado de agencias
    vai te falar (Halbert: abertura conversacional).

    87% dos donos de agencia trabalham mais de 55 horas por semana e
    faturariam MAIS se trabalhassem menos (Ogilvy: dado especifico).

    Se voce nao esta nessa lista exclusiva de 20 agencias que vamos
    aceitar, nao tem segunda chance (Kennedy: exclusividade + urgencia).

  coherence_score: 8.5/10
  validation: "APROVADO — blend coerente, transicoes naturais entre estilos"
```

## Veto Conditions
- Blend que perde a voz original do copywriter
- Misturar estilos conflitantes (elegante + agressivo)
- Blend sem criterio claro de selecao de elementos
