...
creation_request:
  ...
  kb_path: "data/books/{agent}/frameworks_inventory.yaml"
  output_path: "{templates|checklists|workflows}/{artifact_id}.md"
```

## Pre Conditions
- KB do agente existe e contem frameworks_inventory.yaml
- Agente identificado tem pelo menos 3 frameworks relevantes para o artefato
- Tipo de artefato definido (template, checklist, workflow, sop)
- Output path definido e diretorio pai existente
- Artefato solicitado nao duplica artefato existente (ou confirmacao para sobrescrever)

## Execution Flow

### Step 1: Load Agent KB
```
Read: data/books/{agent}/frameworks_inventory.yaml
...
author:
  ...
  squad: "copy"
generated_from:
  kb: "data/books/{agent}/frameworks_inventory.yaml"
...
```markdown
# Artefato Gerado: Checklist de Headline (Gary Bencivenga KB)

**Fonte:** agents/tier-2-executores/gary-bencivenga.md → seção "headline_formulas"
**Tipo:** checklist
**Agente gerador:** @gary-bencivenga

## Checklist: Headline Power Test (Bencivenga)

- [ ] Headline contém benefício específico e mensurável?
- [ ] Passa o teste "E daí?" (leitor entende POR QUE importa)?
- [ ] Evita curiosidade vazia (promessa sem substância)?
- [ ] Inclui elemento de prova ou especificidade?
- [ ] Fala diretamente com UMA pessoa (não "vocês")?
- [ ] Funciona sozinha fora de contexto (sem ler o resto)?
- [ ] Contém urgência implícita ou explícita?
- [ ] Evita jargão e palavras que o avatar não usa?

## Exemplo de Aplicação
❌ "Transforme sua vida com nosso programa"
✅ "437 mentores usaram esse sistema para sair de R$3k para R$30k/mês"
```
