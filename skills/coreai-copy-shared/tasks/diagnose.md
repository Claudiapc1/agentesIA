...
## Pre Conditions
- Briefing completo disponivel (output de briefing.md com campos obrigatorios preenchidos)
- Produto, ICP e canal definidos no briefing (minimo para rodar diagnostico)
- Agentes T0 disponiveis (Hopkins, Schwartz, Collier) para execucao paralela
- Informacao suficiente sobre mercado-alvo para avaliar awareness e sophistication
...
- NÃO diagnosticar sem informacao minima do mercado alvo
- NÃO usar diagnostico incompleto como base para execucao
...
```markdown
# Diagnostic Report — Programa Acelerador Digital

## Tier 0 Agents (Paralelo)

### Hopkins — Market Analysis
- Mercado: Mentoria digital (crescimento 34% a.a.)
- Concorrência: Alta (30+ programas similares no BR)
- Diferencial testável: "Método 3R" como mecanismo único

### Schwartz — Awareness Level
- **Level 3: Solution-Aware** — Sabem que precisam de mentoria/curso,
  mas não conhecem o Método 3R especificamente
- Implicação: Copy deve focar no MECANISMO ÚNICO, não na solução genérica

### Collier — Market Sophistication
- **Stage 3: Mecanismo** — Mercado já viu muitas promessas de
  "fature 6 dígitos". Precisa de mecanismo novo e proof stack forte.

## Recommended Agents (Tier 1-3)
| Prioridade | Agent | Rationale |
|-----------|-------|-----------|
| 1 | @stefan-georgi | RMBC perfeito para Solution-Aware + Mecanismo |
| 2 | @andre-chaperon | SOAP para sequência de emails narrativa |
| 3 | @todd-brown | E5 Method reforça mecanismo único |

## Routing Decision
Writer principal: @stefan-georgi (sales page + emails de cart)
Writer secundário: @andre-chaperon (sequência de PLCs + nurture)
```
