...
## Pre-Conditions
- Oferta high-ticket ($5k+) com preco e entregaveis finalizados
- Avatar do comprador definido com 3 principais objecoes mapeadas
- Modelo de venda definido (1-call close, 2-call, setter+closer)
- Proposta de valor unica (USP) articulada
- Garantia e termos de oferta estabelecidos

## Veto Conditions
- Nao criar script de call sem oferta high-ticket ($5k+) com preco e entregaveis definidos
- Nao executar sem avatar do comprador e suas 3 principais objecoes mapeadas
- Nao produzir sem definir o modelo de venda (1-call close, 2-call, setter+closer)
...
### Before This Task
- `diagnose-avatar.md` - Deep understanding of target market (3Ms - Market)
...
```markdown
# Script de Call — Mentoria Elite (High-Ticket R$12.000)

## ABERTURA (2 min)
"[NOME], obrigado por reservar esse horário. Antes de qualquer coisa,
quero que saiba: essa conversa é sobre VOCÊ. Não vou te empurrar nada.
Meu trabalho é entender se faz sentido trabalharmos juntos. Combinado?"

## DIAGNÓSTICO (15 min)
"Me conta: o que te levou a agendar essa conversa?"
[OUVIR — não interromper]

"E quanto tempo faz que você tenta resolver isso?"
"O que você já tentou antes que não funcionou?"
"Se a gente se encontrar daqui a 12 meses e nada tiver mudado,
como você se sente?"

## PRESCRIÇÃO (5 min)
"Pelo que você me contou, o problema não é falta de conhecimento —
é falta de SISTEMA. Você sabe o que fazer, mas não tem a estrutura
pra executar de forma consistente. Faz sentido?"

## APRESENTAÇÃO DA OFERTA (5 min)
"Eu trabalho com um grupo seleto de [X] pessoas por trimestre.
O investimento é R$12.000 ou 12x de R$1.197.
Isso inclui [STACK resumido]. Quer que eu explique os detalhes?"

## TAKEAWAY CLOSE
"Sinceramente, [NOME], não sei se é pra você. Deixa eu te fazer
uma última pergunta: se eu te garantisse que em 90 dias você [RESULTADO],
isso valeria o investimento?"
```
