...
## Pre-Conditions
- Oferta e CTA claros para o pitch final definidos
- Conteudo de valor denso preparado para os primeiros 15 minutos
- Provas sociais e resultados concretos disponiveis para credibilidade rapida
- Avatar de audiencia cold definido (nunca ouviram falar de voce)
- Duracao planejada definida (60-90 min recomendado para cold)

## Veto Conditions
- Nao criar webinar cold sem oferta e CTA claros para o pitch final
- Nao executar sem conteudo de valor denso para os primeiros 15 minutos (cold nao tolera enrolacao)
- Nao produzir sem provas sociais e resultados concretos para construir credibilidade rapida
...
```markdown
# Cold Webinar Script — Programa Acelerador Digital

## [0:00-0:30] HOOK IMEDIATO (sem aquecimento!)
"Nos próximos 47 minutos eu vou te mostrar como mentores
digitais comuns — sem audiência, sem equipe, sem investimento —
estão faturando R$20-50k por mês com um sistema de 5 passos.
Eu vou te dar os 3 primeiros passos DE GRAÇA nessa apresentação."

## [0:30-2:00] CREDIBILIDADE RÁPIDA
"Quem sou eu pra te ensinar isso? Em 2019 eu faturava R$800/mês.
Em 2024 fiz R$2.3M com esse sistema. [SCREENSHOT de resultado]
Mais importante: 437 alunos já replicaram. [SCROLL de prints]"

## [2:00-15:00] CONTEÚDO DENSO (3 passos dos 5)
"Passo 1: Reposicionamento — pare de ser 'mais um coach'..."
"Passo 2: Oferta Irresistível — o framework do Valor 10x..."
"Passo 3: Funil Mínimo — 1 página, 1 email, 1 call..."

## [15:00-20:00] TRANSIÇÃO PARA PITCH
"Esses 3 passos sozinhos podem te levar a R$5-10k/mês.
Mas os passos 4 e 5 são o que separa R$10k de R$50k.
E é exatamente isso que eu ensino dentro do Acelerador Digital..."

## [20:00-35:00] PITCH + STACK + CLOSE
[Stack completo + urgência + CTA]
```
