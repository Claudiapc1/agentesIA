...
## Pre-Conditions
- Historico de conteudo/interacao previa com a audiencia disponivel
- Oferta definida com transicao natural do conteudo para o pitch
- Segmento da audiencia warm definido (email list, followers, customers)
- Personalidade e character content do apresentador mapeados
- Provas sociais e resultados disponiveis

## Veto Conditions
- Nao criar webinar warm sem historico de conteudo/interacao previa com a audiencia
- Nao executar sem oferta e transicao natural do conteudo para o pitch
- Nao produzir sem definir segmento da audiencia warm (email list, followers, customers)
...
```markdown
# Warm Webinar Script — Mentoria Elite (Audiência Warm)

## [0:00-3:00] ABERTURA COM CONEXÃO
"E aí, galera! Que bom ver vocês aqui. Pra quem me acompanha
no Instagram, vocês sabem que eu venho falando sobre escalar
mentorias nos últimos meses. Hoje eu vou abrir o jogo COMPLETO."

"Manda no chat de onde vocês estão!"
[Interação — warm audience tolera isso, cold não]

## [3:00-8:00] CONTEXTO + HISTÓRIA
"Semana passada eu postei um story sobre como a Fernanda fez
R$18k no primeiro mês usando o Método 3R. Vocês piraram no DM.
Então resolvi fazer esse workshop pra mostrar COMO ela fez."

## [8:00-35:00] CONTEÚDO PROFUNDO (Character Content)
"Pilar 1: Reposicionamento — e eu vou contar uma história
que nunca contei publicamente..."
[Personalidade, vulnerabilidade, opiniões fortes]
[Warm permite mais personality que cold]

## [35:00-45:00] TRANSIÇÃO NATURAL
"Vocês me conhecem. Sabem que eu entrego demais de graça.
Mas existe um nível de acompanhamento que só consigo dar
pra um grupo pequeno. E é sobre isso que eu quero falar agora..."

## [45:00-60:00] PITCH + Q&A INTERATIVO
[Stack + Preço + "Quem tiver dúvida, manda no chat agora"]
```
