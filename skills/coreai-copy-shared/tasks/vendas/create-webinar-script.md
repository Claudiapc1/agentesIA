...
## Pre-Conditions
- "Grande Domino" (crenca central a ser quebrada) definida
- 3 Segredos/Pilares de conteudo estruturados
- Oferta, preco e stack de bonus finalizados para o pitch
- Avatar especifico com objecoes e crencas limitantes mapeadas
- Historia de origem do apresentador preparada
- Formato definido (ao vivo, gravado, hibrido) e duracao planejada

## Veto Conditions
- Nao criar webinar script sem a "Grande Domino" (crenca central a ser quebrada) definida
- Nao executar sem os 3 Segredos/Pilares de conteudo estruturados
- Nao produzir sem oferta, preco e stack de bonus finalizados para o pitch
...
```markdown
# Perfect Webinar Script — Programa Acelerador Digital

## GRANDE DOMINÓ
"A única coisa que você precisa acreditar: É possível criar um negócio
digital de R$30k/mês com seu conhecimento atual, usando um SISTEMA —
sem precisar de audiência grande, sem gravar 200 vídeos."

## SEGREDO #1: O Veículo (Epiphany Bridge)
"Eu tentei de tudo: curso gravado, ebook, lives diárias...
Nada funcionava. Até que descobri que o problema não era MEU CONTEÚDO.
Era o VEÍCULO de entrega. O dia que mudei de 'curso online'
para 'mentoria com sistema' tudo mudou."
→ Crença quebrada: "Preciso criar curso pra vender online"

## SEGREDO #2: O Framework Interno
"O Método 3R: Reposicionar, Reter, Rentabilizar.
Não inventei isso — descobri analisando 200+ mentorias que funcionam."
→ Crença quebrada: "Cada nicho precisa de estratégia diferente"

## SEGREDO #3: O Padrão Externo
"Você não precisa de 10k seguidores. A Fernanda fez R$18k
com uma lista de 340 pessoas. O sistema funciona com audiências pequenas."
→ Crença quebrada: "Preciso de audiência grande pra faturar"

## STACK + CLOSE (Transição)
"Se eu te desse TUDO que precisaria pra implementar os 3 segredos..."
[Stack slide → Preço → Urgência → CTA]
```
