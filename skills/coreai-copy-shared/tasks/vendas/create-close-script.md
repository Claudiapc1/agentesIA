...
## Pre-Conditions
- Oferta e preco finais definidos e aprovados
- Mapeamento das objecoes reais coletadas em calls anteriores
- Contexto de venda definido (telefone, video, presencial)
- Framework de close selecionado (CLOSER, Pain Funnel, SPIN, NEPQ)
- Historico de calls anteriores disponivel (ideal, nao obrigatorio)

## Veto Conditions
- Nao criar close script sem oferta e preco finais definidos
- Nao executar sem mapeamento das objecoes reais coletadas em calls anteriores
- Nao produzir sem definir o contexto de venda (telefone, video, presencial)
...
### Before This Task
- `diagnose-avatar.md` - Understand your prospect deeply
...
### Research Document
`docs/research/close-script-methodology-research.md`
...
```markdown
# Close Script — Mentoria Elite (CLOSER Framework)

## C — CLARIFY (Clarificar a situação)
"[NOME], me conta exatamente onde você está hoje no seu negócio.
Quanto está faturando? Qual sua principal fonte de clientes?"

## L — LABEL (Rotular o problema)
"Então basicamente você tem o conhecimento, tem clientes satisfeitos,
mas não consegue ESCALAR porque depende 100% do seu tempo. Correto?"

## O — OVERVIEW (Visão do passado)
"O que você já tentou pra resolver isso? Curso? Mentoria? Sozinho?"
"E por que não funcionou na sua visão?"

## S — SELL THE VACATION (Vender o destino)
"Imagina se daqui a 90 dias você tivesse um funil rodando que traz
5 calls qualificadas por semana NO AUTOMÁTICO. Sem você precisar
postar todo dia, sem depender de indicação. O que isso mudaria?"

## E — EXPLAIN (Explicar o que você faz)
"O que eu faço é montar esse sistema COM você em 12 semanas.
Não é curso gravado — é implementação guiada. Na semana 1 a gente
monta seu funil, na semana 2 seus anúncios, na semana 3..."

## R — REINFORCE (Reforçar a decisão)
"Você disse que está perdendo R$15-20k/mês por não ter esse sistema.
O investimento é R$12.000. Matematicamente, se funcionar em 30 dias,
você recupera em menos de um mês. Faz sentido pra você?"
```
...
> **REGRA:** Nenhum script de vendas sai sem passar pelo Oráculo. Copy 10/10 ou refaz.
