---
name: copy-book-launch
description: "Constrói o funil de lançamento de livro (book funnel): isca de livro + upsells."
when-to-use: >
  Quando o usuário quiser lançamento de livro, book funnel, funil de livro, isca de livro, ou disser "lançamento de livro", "book funnel", "funil de livro", ou /copy:book-launch.
argument-hint: "[produto / oferta / contexto]"
allowed-tools: "Read, Write, Bash, Glob, Grep, Agent"
user-invocable: true
---

# Copy: Lançamento de livro / isca

Atalho de lançamento de livro / isca. Despacha o especialista certo e segue o workflow de referência.
...
Workflow de referência: `copy-shared/workflows/wf-book-launch.yaml` (seguir as etapas dele).
...
Seguir as etapas de `copy-shared/workflows/wf-book-launch.yaml`. Em cada peça, despachar o
...
## Output
As peças do lançamento de livro / isca, validadas. Listar o que foi gerado e a ordem de uso no funil.
