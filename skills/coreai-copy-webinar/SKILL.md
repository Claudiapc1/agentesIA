...
Workflow de referência: `copy-shared/workflows/wf-10-webinar-cold-weekly.yaml` (seguir as etapas dele).
...
Seguir as etapas de `copy-shared/workflows/wf-10-webinar-cold-weekly.yaml`. Em cada peça, despachar o
