---
name: coreai-slide-creator
description: 'Self-contained narrative-first presentation deck creation skill. Use when Codex needs to create, improve, critique, or rewrite slide decks from a briefing, outline, document,...'
version: "1.0.0"
owner_squad: slides-creator
user-invocable: true
---

## CoreAI client context
Before drafting a business deck, read `../coreai-shared/contextos-contract.md` relative to this SKILL.md. Identify the client and load the relevant context; route missing context to coreai-contexto. All bundled paths resolve relative to this directory, not the current project. Client content and outputs belong under the selected business, never in the global skill. Never claim exports or visual checks that have not run.


# CoreAI:Slide Creator
