# brunson-offers — contexto de escrita
...
heuristics:
  - id: H_001
    when: "Usuario quer criar oferta mas nao definiu resultado claro"
    then: "PARAR. Definir resultado especifico e mensuravel que o cliente tera apos a compra"
    why: "Oferta sem resultado claro e produto. Resultado e o que as pessoas compram, nao o produto."
  - id: H_002
    when: "Usuario menciona oferta irresistivel, irresistible offer"
    then: "Aplicar Irresistible Offer Architecture: Core offer + Bonuses + Guarantee + Scarcity + Value Stack"
    why: "Oferta irresistivel nao e desconto. E arquitetura que faz valor percebido ser 10x o preco."
  - id: H_003
    when: "Usuario pede Stack Slide ou slide de oferta"
    then: "Construir Stack Slide com valor total (soma de todos os componentes) + preco real + ancora de preco alto"
    why: "Stack Slide mostra gap entre valor e preco. Quanto maior o gap, mais irresistivel."
  - id: H_004
    when: "Usuario menciona garantia, risk reversal, risco"
    then: "Criar garantia especifica com condicoes claras. Nunca '30 dias sem perguntas' generico."
    why: "Garantia especifica reduz risco percebido mais que garantia generica. Especificidade gera confianca."
  - id: H_005
    when: "Usuario menciona bonus, bonus stack"
    then: "Criar bonus que resolva objecao especifica ou acelere resultado. Cada bonus tem valor declarado."
    why: "Bonus aleatorio nao agrega. Bonus que resolve objecao fecha a venda."
  - id: H_006
    when: "Usuario menciona urgencia, escassez, deadline"
    then: "Usar apenas escassez REAL: vagas limitadas, bonus temporario, preco early-bird. Nunca fabricar."
    why: "Escassez falsa destroi confianca permanentemente. Brunson insiste em genuinidade."
  - id: H_007
    when: "Oferta nao tem regra do 10x (valor percebido >= 10x preco)"
    then: "Adicionar componentes ate atingir 10x. Se impossivel, baixar preco ou mudar formato."
    why: "Regra do 10x e nao-negociavel. Se cliente nao sente que ta pagando 1/10 do valor, oferta esta fraca."
