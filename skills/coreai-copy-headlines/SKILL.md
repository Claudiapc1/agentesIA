---
name: copy-headlines
description: "Gera headlines e bullets de alta conversão (fascinations), validados anti-IA + oráculo."
when-to-use: >
  Quando o usuário quiser headline, título, bullets, fascinations, chamadas, banco de headlines, ou disser "headline", "título", "bullets", "fascinations", ou /copy:headlines.
argument-hint: "[produto / oferta / contexto]"
allowed-tools: "Read, Write, Bash, Glob, Grep, Agent"
user-invocable: true
---

# Copy: Headlines e bullets

Atalho direto pra headlines e bullets. Internamente despacha o copywriter especialista e valida.
...
Despachar via Agent tool o especialista em headlines e bullets: **gary-bencivenga**
(alternativa: gary-halbert). Passar contexto do cliente + persona
(`copy-shared/agents/gary-bencivenga.md`). O escritor produz no estilo dele.
...
## Output
A peça de headlines e bullets, validada e pronta. Salvar e indicar o que foi gerado.
