...
- **Prompting Bible:** the design prompting guide with worked examples (process described inline; external doc not included in the skill)
- **Page Composition Checklist:** `../coreai-design-shared/validators/page-composition-checklist.md` — post-generation QA
- **Anti-AI Patterns:** `../coreai-design-shared/references/anti-ai-look-patterns.md` — detailed fixes per pattern
- **Prompt Templates:** `../coreai-design-shared/references/prompt-templates-library.md` — 12 copy-paste templates
