...
- Apply the Design Tone Vocabulary (`../coreai-design-shared/references/page-type-patterns.md` Section 0) for palette direction
...
**Fix:**
- Follow the modular type scale (1.25 ratio) from `../coreai-design-shared/references/typography-hierarchy-rules.md`
...
**Fix:**
- Apply the whitespace strategy from `../coreai-design-shared/references/spacing-rhythm-system.md` (generous/balanced/compact)
...
- Design Tone Vocabulary: `../coreai-design-shared/references/page-type-patterns.md` Section 0
- Typography Scale: `../coreai-design-shared/references/typography-hierarchy-rules.md`
- Spacing Strategies: `../coreai-design-shared/references/spacing-rhythm-system.md`
- Component States: the component-states composition process (empty/error/loading states per section)
- Quality Gate: `../coreai-design-shared/validators/page-composition-checklist.md` Section 8
