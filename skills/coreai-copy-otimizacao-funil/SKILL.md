...
Workflow de referência: `copy-shared/workflows/otimizacao-funil.md` (seguir as etapas dele).
...
Seguir as etapas de `copy-shared/workflows/otimizacao-funil.md`. Em cada peça, despachar o
